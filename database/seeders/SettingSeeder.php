...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            // Informasi Akademik Section - Modern & Dynamic
            ['key' => 'academic_info_enabled', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'academic_info_layout_style', 'value' => 'cards', 'type' => 'select', 'group' => 'homepage', 'options' => json_encode(['cards' => 'Info Cards Grid', 'alerts' => 'Alerts/Announcements', 'featured' => 'Featured + Cards'])],
            
            // Section Header
            ['key' => 'academic_info_section_title', 'value' => 'INFORMASI AKADEMIK', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'academic_info_section_subtitle', 'value' => 'Informasi terkini seputar penerimaan mahasiswa dan kegiatan akademik', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'academic_info_section_icon', 'value' => 'fa-graduation-cap', 'type' => 'string', 'group' => 'homepage'],
            
            // PMB Info (Dynamic)
            ['key' => 'pmb_info_enabled', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'pmb_info_title', 'value' => 'PENERIMAAN MAHASISWA BARU {{year}}', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'pmb_info_description', 'value' => 'Pendaftaran mahasiswa baru Program Studi Sistem Informasi telah dibuka. Segera daftarkan diri Anda!', 'type' => 'text', 'group' => 'homepage'],
            ['key' => 'pmb_info_link', 'value' => 'https://pmb.unib.ac.id', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'pmb_info_button_text', 'value' => 'Daftar Sekarang', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'pmb_info_status', 'value' => 'active', 'type' => 'select', 'group' => 'homepage', 'options' => json_encode(['active' => 'Pendaftaran Dibuka', 'closed' => 'Pendaftaran Ditutup', 'coming' => 'Segera Dibuka'])],
            ['key' => 'pmb_info_deadline', 'value' => '31 Desember 2024', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'pmb_info_quota', 'value' => '60', 'type' => 'string', 'group' => 'homepage'],
            
            // Alert/Pengumuman System
            ['key' => 'alert_enabled', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'alert_type', 'value' => 'info', 'type' => 'select', 'group' => 'homepage', 'options' => json_encode(['info' => 'Info', 'warning' => 'Penting', 'success' => 'Sukses', 'error' => 'Darurat'])],
            ['key' => 'alert_title', 'value' => 'Pengumuman Penting', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'alert_message', 'value' => 'Periode pendaftaran mahasiswa baru diperpanjang hingga 31 Desember 2024', 'type' => 'text', 'group' => 'homepage'],
            ['key' => 'alert_link', 'value' => '#', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'alert_button_text', 'value' => 'Lihat Detail', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'alert_closable', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            
            // Additional Info Cards
            ['key' => 'card_1_enabled', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'card_1_title', 'value' => 'Informasi Biaya', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_1_description', 'value' => 'Informasi lengkap mengenai biaya kuliah dan beasiswa', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_1_icon', 'value' => 'fa-money-bill-wave', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_1_link', 'value' => '/biaya', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_1_color', 'value' => '#10b981', 'type' => 'string', 'group' => 'homepage'],
            
            ['key' => 'card_2_enabled', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'card_2_title', 'value' => 'Jadwal Seleksi', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_2_description', 'value' => 'Jadwal lengkap proses seleksi penerimaan mahasiswa', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_2_icon', 'value' => 'fa-calendar-alt', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_2_link', 'value' => '/jadwal', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_2_color', 'value' => '#f59e0b', 'type' => 'string', 'group' => 'homepage'],
            
            ['key' => 'card_3_enabled', 'value' => 'true', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'card_3_title', 'value' => 'Kontak PMB', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_3_description', 'value' => 'Hubungi kami untuk informasi penerimaan', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_3_icon', 'value' => 'fa-phone', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_3_link', 'value' => '/contact', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'card_3_color', 'value' => '#3b82f6', 'type' => 'string', 'group' => 'homepage'],
            
            // Info Card Banner (Generic - can be used for PMB, announcements, etc.)
            ['key' => 'info_card_layout_style', 'value' => 'current', 'type' => 'select', 'group' => 'homepage', 'options' => json_encode(['current' => 'Layout Lengkap', 'compact' => 'Layout Kompak'])],
            ['key' => 'info_card_badge_text', 'value' => 'PENERIMAAN MAHASISWA BARU', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_badge_icon', 'value' => 'fa-graduation-cap', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_title', 'value' => 'Informasi PMB Tahun {{year}}', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_subtitle', 'value' => 'Program Studi Sistem Informasi Universitas Bengkulu', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_button_text', 'value' => 'Info Selengkapnya', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_button_link', 'value' => '/contact', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_button_icon', 'value' => 'fa-arrow-right', 'type' => 'string', 'group' => 'homepage'],
            
            // Info Card Styling
            ['key' => 'info_card_bg_color', 'value' => '#f8fafc', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_border_color', 'value' => '#e5e7eb', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_badge_bg', 'value' => '#f1f5f9', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_badge_dot_color', 'value' => '#f59e0b', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_title_color', 'value' => '#1e293b', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_subtitle_color', 'value' => '#64748b', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_button_bg', 'value' => '#1a246a', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_button_text_color', 'value' => '#ffffff', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'info_card_button_border_color', 'value' => '#1a246a', 'type' => 'string', 'group' => 'homepage'],
            
            // Theme Colors
            ['key' => 'academic_info_bg_color', 'value' => '#f8fafc', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'academic_info_accent_color', 'value' => '#1a246a', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'academic_info_text_color', 'value' => '#1e293b', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'academic_info_secondary_text', 'value' => '#64748b', 'type' => 'string', 'group' => 'homepage'],
            ...
            // Icon Settings - Functional Icons
            ['key' => 'icon_calendar', 'value' => 'far fa-calendar', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_calendar_alt', 'value' => 'far fa-calendar-alt', 'type' => 'string', 'group' => 'icons'],
            ...
            ['key' => 'icon_arrow_left', 'value' => 'fas fa-chevron-left', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_arrow_up', 'value' => 'fas fa-chevron-up', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_arrow_down', 'value' => 'fas fa-chevron-down', 'type' => 'string', 'group' => 'icons'],
            ...
            ['key' => 'icon_book_open', 'value' => 'fas fa-book-open', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_graduation_cap', 'value' => 'fas fa-graduation-cap', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_star', 'value' => 'fas fa-star', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_play_circle', 'value' => 'fas fa-play-circle', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_chart_line', 'value' => 'fas fa-chart-line', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_info_circle', 'value' => 'fa-info-circle', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_download', 'value' => 'fa-download', 'type' => 'string', 'group' => 'icons'],
            // Contact & Social Icons
            ['key' => 'icon_envelope', 'value' => 'fas fa-envelope', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_phone', 'value' => 'fas fa-phone', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_globe', 'value' => 'fas fa-globe', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_linkedin', 'value' => 'fab fa-linkedin', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_linkedin_in', 'value' => 'fab fa-linkedin-in', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_facebook', 'value' => 'fab fa-facebook-f', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_instagram', 'value' => 'fab fa-instagram', 'type' => 'string', 'group' => 'icons'],
            ['key' => 'icon_youtube', 'value' => 'fab fa-youtube', 'type' => 'string', 'group' => 'icons'],
            // Additional Theme Colors
            ['key' => 'theme_text_muted', 'value' => '#94a3b8', 'type' => 'string', 'group' => 'theme'],
            ['key' => 'theme_bg_gray', 'value' => '#f1f5f9', 'type' => 'string', 'group' => 'theme'],
            ['key' => 'theme_border_light', 'value' => '#e5e7eb', 'type' => 'string', 'group' => 'theme'],
            ['key' => 'theme_shadow_color', 'value' => 'rgba(0,0,0,0.08)', 'type' => 'string', 'group' => 'theme'],
            // UI Text Labels
            ['key' => 'text_see_all', 'value' => 'LIHAT SEMUA', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_see_all_lower', 'value' => 'Lihat Semua', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_empty_news', 'value' => 'Belum ada berita terbaru.', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_empty_category', 'value' => 'Belum ada berita', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_empty_academic', 'value' => 'Belum Ada Informasi Akademik', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_register_now', 'value' => 'Daftar Sekarang', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_view_detail', 'value' => 'Lihat Detail', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_download_material', 'value' => 'Unduh Materi', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_view_all_activities', 'value' => 'Lihat Semua Kegiatan Akademik', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_participants', 'value' => 'Peserta', 'type' => 'string', 'group' => 'ui_text'],
            ['key' => 'text_latest', 'value' => 'TERBARU', 'type' => 'string', 'group' => 'ui_text'],
