@php
    ...
    try {
        $icons = [
            ...
            'calendar_alt' => App\Models\Setting::where('key', 'icon_calendar_alt')->value('value') ?? 'far fa-calendar-alt',
            'users' => App\Models\Setting::where('key', 'icon_users')->value('value') ?? 'fas fa-users',
            'location' => App\Models\Setting::where('key', 'icon_location')->value('value') ?? 'fas fa-map-marker-alt',
            'arrow_right' => App\Models\Setting::where('key', 'icon_arrow_right')->value('value') ?? 'fas fa-arrow-right',
            'arrow_left' => App\Models\Setting::where('key', 'icon_arrow_left')->value('value') ?? 'fas fa-chevron-left',
            'arrow_up' => App\Models\Setting::where('key', 'icon_arrow_up')->value('value') ?? 'fas fa-chevron-up',
            'arrow_down' => App\Models\Setting::where('key', 'icon_arrow_down')->value('value') ?? 'fas fa-chevron-down',
            ...
            'book_open' => App\Models\Setting::where('key', 'icon_book_open')->value('value') ?? 'fas fa-book-open',
            'graduation_cap' => App\Models\Setting::where('key', 'icon_graduation_cap')->value('value') ?? 'fas fa-graduation-cap',
            'star' => App\Models\Setting::where('key', 'icon_star')->value('value') ?? 'fas fa-star',
            'play_circle' => App\Models\Setting::where('key', 'icon_play_circle')->value('value') ?? 'fas fa-play-circle',
            'chart_line' => App\Models\Setting::where('key', 'icon_chart_line')->value('value') ?? 'fas fa-chart-line',
            'info_circle' => App\Models\Setting::where('key', 'icon_info_circle')->value('value') ?? 'fa-info-circle',
            'download' => App\Models\Setting::where('key', 'icon_download')->value('value') ?? 'fa-download',
            'envelope' => App\Models\Setting::where('key', 'icon_envelope')->value('value') ?? 'fas fa-envelope',
            'phone' => App\Models\Setting::where('key', 'icon_phone')->value('value') ?? 'fas fa-phone',
            'globe' => App\Models\Setting::where('key', 'icon_globe')->value('value') ?? 'fas fa-globe',
            'linkedin' => App\Models\Setting::where('key', 'icon_linkedin')->value('value') ?? 'fab fa-linkedin',
            'linkedin_in' => App\Models\Setting::where('key', 'icon_linkedin_in')->value('value') ?? 'fab fa-linkedin-in',
            'facebook' => App\Models\Setting::where('key', 'icon_facebook')->value('value') ?? 'fab fa-facebook-f',
            'instagram' => App\Models\Setting::where('key', 'icon_instagram')->value('value') ?? 'fab fa-instagram',
            'youtube' => App\Models\Setting::where('key', 'icon_youtube')->value('value') ?? 'fab fa-youtube',
        ];
        ...
        $themeColors = [
            ...
            'text_muted' => App\Models\Setting::where('key', 'theme_text_muted')->value('value') ?? '#94a3b8',
            'border_color' => App\Models\Setting::where('key', 'theme_border_color')->value('value') ?? '#e2e8f0',
            'border_light' => App\Models\Setting::where('key', 'theme_border_light')->value('value') ?? '#e5e7eb',
            'bg_light' => App\Models\Setting::where('key', 'theme_bg_light')->value('value') ?? '#f8fafc',
            'bg_gray' => App\Models\Setting::where('key', 'theme_bg_gray')->value('value') ?? '#f1f5f9',
            'bg_white' => App\Models\Setting::where('key', 'theme_bg_white')->value('value') ?? '#ffffff',
            'shadow_color' => App\Models\Setting::where('key', 'theme_shadow_color')->value('value') ?? 'rgba(0,0,0,0.08)',
            'icon_primary' => App\Models\Setting::where('key', 'theme_icon_primary')->value('value') ?? '#1a246a',
            'icon_muted' => App\Models\Setting::where('key', 'theme_icon_muted')->value('value') ?? '#94a3b8',
        ];
        ...
        $componentStyles = [
            'white_bg' => App\Models\Setting::where('key', 'component_white_bg')->value('value') ?? '#ffffff',
            'location_badge_bg' => App\Models\Setting::where('key', 'component_location_badge_bg')->value('value') ?? '#fef3c7',
            'location_badge_text' => App\Models\Setting::where('key', 'component_location_badge_text')->value('value') ?? '#92400e',
            'tag_bg' => App\Models\Setting::where('key', 'component_tag_bg')->value('value') ?? '#e8eaf6',
            'tag_text' => App\Models\Setting::where('key', 'component_tag_text')->value('value') ?? '#1a246a',
            'border_light' => App\Models\Setting::where('key', 'component_border_light')->value('value') ?? '#e5e7eb',
            'shadow_light' => App\Models\Setting::where('key', 'component_shadow_light')->value('value') ?? 'rgba(0,0,0,0.06)',
        ];

        // Fetch emoji and symbols
        $symbols = [
            'calendar' => App\Models\Setting::where('key', 'emoji_calendar')->value('value') ?? '📅',
            'star' => App\Models\Setting::where('key', 'emoji_star')->value('value') ?? '⭐',
            'status_open' => App\Models\Setting::where('key', 'status_icon_open')->value('value') ?? '🟢',
            'status_ongoing' => App\Models\Setting::where('key', 'status_icon_ongoing')->value('value') ?? '🔵',
            'status_completed' => App\Models\Setting::where('key', 'status_icon_completed')->value('value') ?? '⚪',
        ];

        // Fetch card styling
        $cardStyles = [
            'border_radius' => App\Models\Setting::where('key', 'card_border_radius')->value('value') ?? '20px',
            'shadow_default' => App\Models\Setting::where('key', 'card_shadow_default')->value('value') ?? '0 4px 20px rgba(0,0,0,0.06)',
            'shadow_hover' => App\Models\Setting::where('key', 'card_shadow_hover')->value('value') ?? '0 8px 32px rgba(26, 36, 106, 0.15)',
            'transition' => App\Models\Setting::where('key', 'card_transition')->value('value') ?? 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
        ];
    } catch (\Exception $e) {
        $icons = [
            'calendar' => 'far fa-calendar',
            'calendar_alt' => 'far fa-calendar-alt',
            'users' => 'fas fa-users',
        ...
        $componentStyles = [
            'white_bg' => '#ffffff',
            'location_badge_bg' => '#fef3c7',
            'location_badge_text' => '#92400e',
            'tag_bg' => '#e8eaf6',
            'tag_text' => '#1a246a',
            'border_light' => '#e5e7eb',
        ...
        $cardStyles = [
            'border_radius' => '20px',
            'shadow_default' => '0 4px 20px rgba(0,0,0,0.06)',
            'shadow_hover' => '0 8px 32px rgba(26, 36, 106, 0.15)',
...
<section style="padding: 90px 0; background: linear-gradient(to bottom, {{ $academicColors['bg_start'] }} 0%, {{ $academicColors['bg_end'] }} 100%); position: relative;">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        ...
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            ...
            <p style="font-size: 17px; color: {{ $themeColors['text_secondary'] }}; max-width: 650px; margin: 0 auto; line-height: 1.7;" data-aos="fade-up" data-aos-delay="200">
        ...
        @if($academicPosts->count() > 0)
            ...
            <div style="display: grid; grid-template-columns: 1.3fr 1fr; gap: 28px; margin-bottom: 50px;" data-aos="fade-up" data-aos-delay="300">
                ...
                <div onclick="window.location='{{ route('blog.show', $featuredPost->slug) }}'"
                     style="background: {{ $themeColors['bg_white'] }}; border-radius: 20px; overflow: hidden; cursor: pointer; transition: all 0.3s ease; border: 1px solid {{ $themeColors['border_color'] }}; box-shadow: 0 4px 20px {{ $themeColors['shadow_color'] }};"
                     onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 16px 50px rgba(26, 36, 106, 0.15)'; this.style.borderColor='{{ $academicColors['primary'] }}';"
                     onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 20px {{ $themeColors['shadow_color'] }}'; this.style.borderColor='{{ $themeColors['border_color'] }}';">

                    <!-- Terbaru Badge -->
                    <div style="position: absolute; top: 20px; left: 20px; z-index: 10; padding: 8px 18px; background: {{ $academicColors['primary'] }}; border-radius: 8px; box-shadow: 0 4px 15px rgba(26,36,106,0.25);">
                        <span style="font-size: 11px; font-weight: 700; color: {{ $componentStyles['white_bg'] }}; letter-spacing: 0.5px;">{{ $symbols['calendar'] }} {{ $uiTexts['latest'] }}</span>
                    </div>

                    <!-- Image -->
                    @if($featuredPost->featured_image)
                        <div style="position: relative; height: 320px; overflow: hidden; background: {{ $themeColors['bg_gray'] }};">
                        ...
                        <div style="position: relative; height: 320px; background: linear-gradient(135deg, #e8eaf6, #c5cae9); display: flex; align-items: center; justify-content: center;">
                            <div style="text-align: center;">
                                <div style="width: 100px; height: 100px; background: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; box-shadow: 0 8px 30px rgba(26,36,106,0.2); border: 4px solid rgba(26,36,106,0.1);">
                                    <i class="{{ $icons['book_open'] }}" style="font-size: 42px; color: {{ $academicColors['primary'] }};"></i>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div style="padding: 28px;">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 18px;">
                            ...
                            @php
                            $statusColors = [
                                'open' => ['bg' => '#dcfce7', 'text' => '#166534', 'icon' => $symbols['status_open']],
                                'ongoing' => ['bg' => '#dbeafe', 'text' => '#1e40af', 'icon' => $symbols['status_ongoing']],
                                'completed' => ['bg' => '#f1f5f9', 'text' => '#64748b', 'icon' => $symbols['status_completed']],
                            ];
                            ...
                            <!-- Location Badge -->
                            <div style="padding: 6px 14px; background: {{ $componentStyles['location_badge_bg'] }}; border-radius: 20px; display: flex; align-items: center; gap: 6px;">
                                <i class="{{ $icons['location'] }}" style="font-size: 10px; color: {{ $componentStyles['location_badge_text'] }};"></i>
                                <span style="font-size: 11px; font-weight: 600; color: {{ $componentStyles['location_badge_text'] }};">{{ $featuredMeta['location'] }}</span>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; align-items: center; gap: 18px; margin-bottom: 16px;">
                            <div style="display: flex; align-items: center; gap: 6px;">
                                <i class="{{ $icons['calendar'] }}" style="color: {{ $academicColors['primary'] }}; font-size: 13px;"></i>
                                <span style="font-size: 13px; color: {{ $themeColors['text_secondary'] }}; font-weight: 500;">{{ $featuredPost->published_at->format('d M Y') }}</span>
                            </div>
                            <div style="display: flex; align-items: center; gap: 6px;">
                                <i class="{{ $icons['users'] }}" style="color: {{ $academicColors['primary'] }}; font-size: 13px;"></i>
                                <span style="font-size: 13px; color: {{ $themeColors['text_secondary'] }}; font-weight: 500;">{{ $featuredMeta['participants'] }} {{ $uiTexts['participants'] }}</span>
                            </div>
                        </div>

                        <!-- Title -->
                        <h3 style="font-size: 24px; font-weight: 800; color: {{ $themeColors['text_primary'] }}; margin: 0 0 14px 0; line-height: 1.3;">
                            {{ $featuredPost->title }}
                        </h3>

                        <!-- Excerpt -->
                        <p style="color: {{ $themeColors['text_secondary'] }}; line-height: 1.7; margin: 0 0 18px 0; font-size: 14px; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 22px;">
                            @foreach($featuredMeta['tags'] as $tag)
                                <span style="padding: 6px 12px; background: {{ $componentStyles['tag_bg'] }}; color: {{ $componentStyles['tag_text'] }}; border-radius: 12px; font-size: 12px; font-weight: 600;">
                                    #{{ $tag }}
                                </span>
                            @endforeach
                        </div>
                        ...
                        <div style="display: inline-flex; align-items: center; gap: 10px; padding: 13px 26px; background: {{ $cta['bg'] }}; color: {{ $componentStyles['white_bg'] }}; border-radius: 10px; font-weight: 700; font-size: 14px; box-shadow: 0 4px 16px {{ $cta['bg'] }}40; transition: all 0.2s ease;"
                            ...
                            <span>{{ $cta['text'] }}</span>
                            <i class="{{ $cta['icon'] }}" style="font-size: 12px;"></i>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 18px;">
                    @foreach($academicPosts->slice(1, 4) as $index => $post)
                        ...
                        <div onclick="window.location='{{ route('blog.show', $post->slug) }}'"
                             style="background: {{ $themeColors['bg_white'] }}; border-radius: 14px; overflow: hidden; cursor: pointer; transition: all 0.3s ease; border: 1px solid {{ $themeColors['border_color'] }}; box-shadow: 0 2px 10px {{ $themeColors['shadow_color'] }}; display: flex; gap: 16px;"
                             onmouseover="this.style.transform='translateX(6px)'; this.style.boxShadow='0 8px 30px rgba(26, 36, 106, 0.12)'; this.style.borderColor='{{ $academicColors['primary'] }}';"
                             onmouseout="this.style.transform='translateX(0)'; this.style.boxShadow='0 2px 10px {{ $themeColors['shadow_color'] }}'; this.style.borderColor='{{ $themeColors['border_color'] }}';">
                            ...
                            @else
                                <div style="position: relative; width: 140px; min-width: 140px; height: 140px; background: linear-gradient(135deg, {{ $themeColors['bg_gray'] }}, #c5cae9); display: flex; align-items: center; justify-content: center;">
                                    <div style="width: 50px; height: 50px; background: {{ $themeColors['bg_white'] }}; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 16px rgba(26,36,106,0.15); border: 3px solid rgba(26,36,106,0.1);">
                                        <i class="{{ $icons['graduation_cap'] }}" style="font-size: 20px; color: {{ $academicColors['primary'] }};"></i>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div style="flex: 1; padding: 16px 16px 16px 0; display: flex; flex-direction: column; justify-content: space-between;">
                                ...
                                <div>
                                    ...
                                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 10px;">
                                        <div style="display: flex; align-items: center; gap: 4px;">
                                            <i class="{{ $icons['calendar'] }}" style="color: {{ $academicColors['primary'] }}; font-size: 10px;"></i>
                                            <span style="font-size: 11px; color: {{ $themeColors['text_secondary'] }}; font-weight: 500;">{{ $post->published_at->format('d M Y') }}</span>
                                        </div>
                                        <div style="display: flex; align-items: center; gap: 4px;">
                                            <i class="{{ $icons['users'] }}" style="color: {{ $academicColors['primary'] }}; font-size: 10px;"></i>
                                            <span style="font-size: 11px; color: {{ $themeColors['text_secondary'] }}; font-weight: 500;">{{ $meta['participants'] }} {{ $uiTexts['participants'] }}</span>
                                        </div>
                                        <div style="display: flex; align-items: center; gap: 4px;">
                                            <i class="{{ $icons['location'] }}" style="font-size: 9px; color: {{ $academicColors['accent'] }};"></i>
                                            <span style="font-size: 11px; color: {{ $themeColors['text_secondary'] }};">{{ Str::limit($meta['location'], 20) }}</span>
                                        </div>
                                    </div>

                                    <!-- Title -->
                                    <h3 style="font-size: 15px; font-weight: 700; color: {{ $themeColors['text_primary'] }}; margin: 0 0 8px 0; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                        {{ $post->title }}
                                    </h3>
                                    ...
                                    <div style="display: flex; flex-wrap: wrap; gap: 5px;">
                                        @foreach(array_slice($meta['tags'], 0, 2) as $tag)
                                            <span style="padding: 3px 8px; background: {{ $componentStyles['tag_bg'] }}; color: {{ $componentStyles['tag_text'] }}; border-radius: 8px; font-size: 9px; font-weight: 600;">
                                                #{{ $tag }}
                                            </span>
                                        @endforeach
                                    </div>
                                ...
                                <div style="margin-top: 10px;">
                                    ...
                                    <div style="display: inline-flex; align-items: center; gap: 6px; padding: 7px 14px; background: {{ $cta['bg'] }}; color: {{ $componentStyles['white_bg'] }}; border-radius: 7px; font-weight: 600; font-size: 11px; box-shadow: 0 2px 8px {{ $cta['bg'] }}30; transition: all 0.2s ease;"
                    ...
                    @foreach($academicPosts as $index => $post)
                        ...
                        <div onclick="window.location='{{ route('blog.show', $post->slug) }}'"
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 16px; font-size: 13px; color: #64748b;">
                                <div style="display: flex; align-items: center; gap: 6px;">
                                    <i class="{{ $icons['location'] }}" style="color: {{ $academicColors['accent'] }};"></i>
                            ...
                            <div style="padding: 20px;">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 16px;">
                                    <div style="display: flex; align-items: center; gap: 8px; font-size: 13px; color: #64748b;">
                                        <i class="{{ $icons['location'] }}" style="color: {{ $academicColors['accent'] }}; width: 16px;"></i>
                                        <span>{{ $meta['location'] }}</span>
                                    </div>
                                    <div style="display: flex; align-items: center; gap: 8px; font-size: 13px; color: #64748b;">
            ...
            <div style="text-align: center; margin-top: 50px;" data-aos="fade-up" data-aos-delay="400">
                <a href="{{ route('blog.index') }}?category=akademik"
                   ...
                   onmouseout="this.style.background='{{ $academicColors['primary'] }}'; this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 16px rgba(26, 36, 106, 0.2)';">
                    <span>{{ $uiTexts['view_all_activities'] }}</span>
                    <i class="{{ $icons['arrow_right'] }}" style="font-size: 13px;"></i>
                </a>
            </div>
        @else
            <!-- Empty State -->
            <div style="text-align: center; padding: 80px 40px; background: {{ $themeColors['bg_white'] }}; border-radius: 16px; border: 2px dashed {{ $themeColors['border_light'] }};" data-aos="fade-up">
                <div style="width: 100px; height: 100px; background: linear-gradient(135deg, {{ $themeColors['bg_gray'] }}, #c5cae9); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 28px;">
                    <i class="{{ $icons['graduation_cap'] }}" style="font-size: 42px; color: {{ $academicColors['primary'] }};"></i>
                </div>
                <h3 style="font-size: 24px; font-weight: 700; color: {{ $themeColors['text_primary'] }}; margin: 0 0 12px 0;">
                    {{ $uiTexts['empty_academic'] }}
                </h3>
...
@php
    ...
    try {
        ...
        if ($teachersFromDb->count() > 0) {
            ...
            // No dummy data - show empty state if no teachers
            $dosenData = [];
        }
    } catch (\Exception $e) {
        // No dummy data on error - show empty state
        $dosenData = [];
    }
@endphp
...
<section style="padding: 100px 0; background: linear-gradient(to bottom, #f0f4ff 0%, #fafbff 100%); position: relative; overflow: hidden;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
                        ...
                        <div class="dosen-card-clean" style="background: #fff; border-radius: 16px; overflow: hidden; border: 1px solid #e5e7eb; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);">
                            ...
                            <div style="padding: 24px;">
                                ...
                                <div style="display: flex; gap: 10px;">
                                    <div style="width: 36px; height: 36px; background: {{ $themeColors['bg_gray'] }}; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: {{ $themeColors['text_secondary'] }}; font-size: 14px; transition: all 0.2s; cursor: pointer;" class="contact-link">
                                    ...
                                    <div style="width: 36px; height: 36px; background: {{ $themeColors['bg_gray'] }}; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: {{ $themeColors['text_secondary'] }}; font-size: 14px; transition: all 0.2s; cursor: pointer;" class="contact-link">
                                        <i class="{{ $icons['graduation_cap'] }}"></i>
                                    </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 28px;" data-aos="fade-up" data-aos-delay="100">
            ...
            <div style="background: {{ $componentStyles['white_bg'] }}; border-radius: {{ $cardStyles['border_radius'] }}; overflow: hidden; border: 1px solid {{ $componentStyles['border_light'] }}; transition: {{ $cardStyles['transition'] }}; box-shadow: {{ $cardStyles['shadow_default'] }};"
        ...
        <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 30px;" data-aos="fade-up" data-aos-delay="100">
            ...
            <div style="background: #fff; border-radius: 24px; overflow: hidden; border: 1px solid #e2e8f0; box-shadow: 0 8px 30px rgba(0,0,0,0.08); transition: all 0.4s ease;"
                ...
                <div style="position: absolute; top: 24px; right: 24px; z-index: 10; padding: 10px 20px; background: linear-gradient(135deg, #fbbf24, #f59e0b); border-radius: 12px; box-shadow: 0 6px 20px rgba(251, 191, 36, 0.3);">
                    <span style="font-size: 12px; font-weight: 800; color: #78350f; letter-spacing: 0.5px;">{{ $symbols['star'] }} KAPRODI</span>
                </div>
...
@php
    ...
    // Video settings
    $videoSettings = [
        'title' => App\Models\Setting::where('key', 'video_title')->value('value') ?? 'Video Profil Program Studi Sistem Informasi',
        'title_short' => App\Models\Setting::where('key', 'video_title_short')->value('value') ?? 'Video Profil Sistem Informasi',
        'description' => App\Models\Setting::where('key', 'video_description')->value('value') ?? 'Kenali lebih dekat Program Studi Sistem Informasi Universitas Bengkulu',
        'description_short' => App\Models\Setting::where('key', 'video_description_short')->value('value') ?? 'Kenali Lebih Dekat',
        'iframe_title' => App\Models\Setting::where('key', 'video_iframe_title')->value('value') ?? 'Video Profil Program Studi Sistem Informasi UNIB',
        'kenali_title' => App\Models\Setting::where('key', 'kenali_video_title')->value('value') ?? 'Video Profil Sistem Informasi',
        'kenali_description' => App\Models\Setting::where('key', 'kenali_video_description')->value('value') ?? 'Kenali Lebih Dekat',
    ];
    ...
    // Video ID - No fallback, must be set in database
    $kenaliVideoId = KenaliSetting::getValue('video_id', null);
    if (empty($kenaliVideoId)) {
        $kenaliVideoId = !empty($homeSettings['youtube_video_id']) ? $homeSettings['youtube_video_id'] : null;
    }
        ...
        <div style="margin-bottom: 60px; text-align: center;" data-aos="fade-up" data-aos-delay="100">
            <div style="max-width: 800px; margin: 0 auto; background: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.1); padding: 30px;">
                <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 15px;">
                    ...
                    @else
                        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(135deg, #f0f4ff 0%, #e8eaf6 100%); border-radius: 15px; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 15px;">
                            <i class="{{ $icons['play_circle'] ?? 'fas fa-play-circle' }}" style="font-size: 64px; color: #cbd5e1;"></i>
                            <p style="color: #64748b; font-size: 14px; margin: 0; text-align: center;">Video belum tersedia</p>
                        </div>
                    @endif
                </div>
        ...
        <div style="margin-bottom: 50px; text-align: center;" data-aos="fade-up" data-aos-delay="100">
            <div style="max-width: 1000px; margin: 0 auto; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.2); padding: 40px;">
                <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 16px; box-shadow: inset 0 4px 20px rgba(0,0,0,0.1);">
                    ...
                    @else
                        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(135deg, #f0f4ff 0%, #e8eaf6 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 15px;">
                            <i class="{{ $icons['play_circle'] ?? 'fas fa-play-circle' }}" style="font-size: 64px; color: #cbd5e1;"></i>
                            <p style="color: #64748b; font-size: 14px; margin: 0; text-align: center;">Video belum tersedia</p>
                        </div>
                    @endif
            ...
            <div>
                <div style="background: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.15); padding: 24px;">
                    <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 12px;">
                        ...
                        @else
                            <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(135deg, #f0f4ff 0%, #e8eaf6 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 12px;">
                                <i class="{{ $icons['play_circle'] ?? 'fas fa-play-circle' }}" style="font-size: 48px; color: #cbd5e1;"></i>
                                <p style="color: #64748b; font-size: 13px; margin: 0; text-align: center;">Video belum tersedia</p>
                            </div>
                        @endif
                    </div>
                    <div style="margin-top: 16px; text-align: center;">
                        <h4 style="color: #1e293b; font-size: 16px; font-weight: 700; margin: 0 0 6px 0;">
                            {{ $videoSettings['kenali_title'] }}
                        </h4>
                        <p style="color: #64748b; font-size: 13px; margin: 0;">
                            <i class="{{ $icons['play_circle'] }}" style="color: #fbbf24;"></i> {{ $videoSettings['kenali_description'] }}
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="kenali-tab-panel {{ $index === 0 ? 'active' : '' }}" data-panel="{{ $tab['id'] }}"
                        ...
                        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 16px; padding: 30px; border: 1px solid rgba(255,255,255,0.2);">
                            ...
                            <div style="display: inline-flex; align-items: center; gap: 12px; padding: 12px 24px; background: rgba(255,255,255,0.15); border-radius: 30px; border: 2px solid {{ $tab['color'] }};">
                                <i class="{{ $icons['chart_line'] }}" style="color: {{ $tab['color'] }}; font-size: 18px;"></i>
                ...
                <div style="background: {{ $alumniCardBg }}; backdrop-filter: blur(10px); border-radius: 20px; padding: 30px; border: 1px solid {{ $alumniCardBorder }}; transition: all 0.3s ease; position: relative; overflow: hidden;" class="alumni-card" data-aos="fade-up" data-aos-delay="{{ ($index % 3) * 100 }}" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 15px 40px rgba(255, 107, 53, 0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none';">
                    ...
                    <div style="margin-bottom: 15px;">
                        <div style="display: flex; gap: 3px;">
                            @for($i = 0; $i < $alumni->rating; $i++)
                            <i class="{{ $icons['star'] }}" style="color: {{ $alumniAccentColor }}; font-size: 14px;"></i>
                            @endfor
                        </div>
                    </div>
...
@php
    ...
    try {
        ...
        $infoCardShow = HomeSetting::where('key', 'info_card_show')->value('value') ?? '0';
        
        // Try new generic keys first, fallback to old PMB keys for backward compatibility
        $infoCardLayoutStyle = HomeSetting::where('key', 'info_card_layout_style')->value('value') 
                            ?? HomeSetting::where('key', 'pmb_layout_style')->value('value') 
                            ?? 'current';
        
        $infoCardBadgeText = HomeSetting::where('key', 'info_card_badge_text')->value('value') 
                          ?? HomeSetting::where('key', 'pmb_badge_text')->value('value') 
                          ?? 'INFORMASI PENTING';
        
        $infoCardBadgeIcon = HomeSetting::where('key', 'info_card_badge_icon')->value('value') 
                          ?? HomeSetting::where('key', 'pmb_badge_icon')->value('value') 
                          ?? 'fa-info-circle';
        
        $infoCardTitleTemplate = HomeSetting::where('key', 'info_card_title')->value('value') 
                              ?? HomeSetting::where('key', 'pmb_title')->value('value') 
                              ?? 'Informasi Terkini Tahun {{year}}';
        $infoCardTitle = str_replace('{{year}}', date('Y'), $infoCardTitleTemplate);
        
        $infoCardSubtitle = HomeSetting::where('key', 'info_card_subtitle')->value('value') 
                         ?? HomeSetting::where('key', 'pmb_subtitle')->value('value') 
                         ?? 'Program Studi Sistem Informasi Universitas Bengkulu';
        
        $infoCardButtonText = HomeSetting::where('key', 'info_card_button_text')->value('value') 
                           ?? HomeSetting::where('key', 'pmb_button_text')->value('value') 
                           ?? 'Info Selengkapnya';
        
        $infoCardButtonLink = HomeSetting::where('key', 'info_card_button_link')->value('value') 
                           ?? HomeSetting::where('key', 'pmb_button_link')->value('value') 
                           ?? '/contact';
        
        $infoCardButtonIcon = HomeSetting::where('key', 'info_card_button_icon')->value('value') 
                           ?? HomeSetting::where('key', 'pmb_button_icon')->value('value') 
                           ?? 'fa-arrow-right';
        
        // Styling options
        $infoCardBgColor = HomeSetting::where('key', 'info_card_bg_color')->value('value') 
                        ?? HomeSetting::where('key', 'pmb_bg_color')->value('value') 
                        ?? '#f8fafc';
        
        $infoCardBorderColor = HomeSetting::where('key', 'info_card_border_color')->value('value') 
                            ?? HomeSetting::where('key', 'pmb_border_color')->value('value') 
                            ?? '#e5e7eb';
        
        $infoCardBadgeBg = HomeSetting::where('key', 'info_card_badge_bg')->value('value') 
                        ?? HomeSetting::where('key', 'pmb_badge_bg')->value('value') 
                        ?? '#f1f5f9';
        
        $infoCardBadgeDotColor = HomeSetting::where('key', 'info_card_badge_dot_color')->value('value') 
                              ?? HomeSetting::where('key', 'pmb_badge_dot_color')->value('value') 
                              ?? '#f59e0b';
        
        $infoCardTitleColor = HomeSetting::where('key', 'info_card_title_color')->value('value') 
                           ?? HomeSetting::where('key', 'pmb_title_color')->value('value') 
                           ?? '#1e293b';
        
        $infoCardSubtitleColor = HomeSetting::where('key', 'info_card_subtitle_color')->value('value') 
                              ?? HomeSetting::where('key', 'pmb_subtitle_color')->value('value') 
                              ?? '#64748b';
        
        $infoCardButtonBg = HomeSetting::where('key', 'info_card_button_bg')->value('value') 
                         ?? HomeSetting::where('key', 'pmb_button_bg')->value('value') 
                         ?? '#1a246a';
        
        $infoCardButtonTextColor = HomeSetting::where('key', 'info_card_button_text_color')->value('value') 
                                ?? HomeSetting::where('key', 'pmb_button_text_color')->value('value') 
                                ?? '#ffffff';
        
        $infoCardButtonBorderColor = HomeSetting::where('key', 'info_card_button_border_color')->value('value') 
                                  ?? HomeSetting::where('key', 'pmb_button_border_color')->value('value') 
                                  ?? '#1a246a';
        
        // Campus identity
        $infoCardCampusLogo = HomeSetting::where('key', 'info_card_campus_logo')->value('value') ?? null;
        $infoCardCampusName = HomeSetting::where('key', 'info_card_campus_name')->value('value') 
                           ?? 'Universitas Bengkulu';
        $infoCardCampusShortName = HomeSetting::where('key', 'info_card_campus_short_name')->value('value') 
                                ?? 'UNIB';
        
        // Gradient colors for modern design
        $infoCardGradientStart = HomeSetting::where('key', 'info_card_gradient_start')->value('value') 
                              ?? '#1a246a';
        $infoCardGradientEnd = HomeSetting::where('key', 'info_card_gradient_end')->value('value') 
                            ?? '#3b82f6';
    } catch (\Exception $e) {
        // Fallback values if error
        $infoCardShow = '0';
        $infoCardLayoutStyle = 'current';
        $infoCardBadgeText = 'INFORMASI PENTING';
        $infoCardBadgeIcon = 'fa-info-circle';
        $infoCardTitle = 'Informasi Terkini Tahun ' . date('Y');
        $infoCardSubtitle = 'Program Studi Sistem Informasi Universitas Bengkulu';
        $infoCardButtonText = 'Info Selengkapnya';
        $infoCardButtonLink = '/contact';
        $infoCardButtonIcon = 'fa-arrow-right';
        $infoCardBgColor = '#f8fafc';
        $infoCardBorderColor = '#e5e7eb';
        $infoCardBadgeBg = '#f1f5f9';
        $infoCardBadgeDotColor = '#f59e0b';
        $infoCardTitleColor = '#1e293b';
        $infoCardSubtitleColor = '#64748b';
        $infoCardButtonBg = '#1a246a';
        $infoCardButtonTextColor = '#ffffff';
        $infoCardButtonBorderColor = '#1a246a';
...
<section style="padding: 80px 0; background: #ffffff;">
    <div class="container" data-aos="fade-up">
        ...
        <div style="background: linear-gradient(135deg, {{ $infoCardGradientStart }}15 0%, {{ $infoCardGradientEnd }}15 100%); border: 3px solid transparent; background-image: linear-gradient(white, white), linear-gradient(135deg, {{ $infoCardGradientStart }}, {{ $infoCardGradientEnd }}); background-origin: border-box; background-clip: padding-box, border-box; border-radius: 24px; padding: 50px; display: flex; justify-content: space-between; align-items: center; gap: 40px; box-shadow: 0 15px 50px rgba(0,0,0,0.12), 0 0 0 1px {{ $infoCardGradientStart }}20; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden;" onmouseover="this.style.transform='translateY(-8px) scale(1.01)'; this.style.boxShadow='0 25px 70px rgba(0,0,0,0.18), 0 0 0 1px {{ $infoCardGradientStart }}40';" onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 15px 50px rgba(0,0,0,0.12), 0 0 0 1px {{ $infoCardGradientStart }}20';">
            ...
            <div style="position: absolute; top: -80px; right: -80px; width: 250px; height: 250px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}15, {{ $infoCardGradientEnd }}15); border-radius: 50%; filter: blur(40px);"></div>
            <div style="position: absolute; bottom: -50px; left: -50px; width: 180px; height: 180px; background: linear-gradient(135deg, {{ $infoCardGradientEnd }}12, {{ $infoCardGradientStart }}12); border-radius: 50%; filter: blur(35px);"></div>
            
            <!-- Animated Corner Accent -->
            <div style="position: absolute; top: 0; left: 0; width: 100px; height: 100px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}, {{ $infoCardGradientEnd }}); opacity: 0.1; clip-path: polygon(0 0, 100% 0, 0 100%);"></div>
            
            <div style="flex: 1; position: relative; z-index: 2;">
                <div style="display: inline-flex; align-items: center; gap: 12px; padding: 10px 24px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}, {{ $infoCardGradientEnd }}); border-radius: 30px; margin-bottom: 20px; box-shadow: 0 8px 25px {{ $infoCardGradientStart }}40; position: relative; overflow: hidden;">
                    ...
                    @if($infoCardBadgeIcon)
                        <i class="fas {{ $infoCardBadgeIcon }}" style="font-size: 14px; color: #fff; position: relative; z-index: 2;"></i>
                    @endif
                    <span style="font-size: 13px; font-weight: 800; color: #fff; letter-spacing: 1.5px; text-transform: uppercase; position: relative; z-index: 2;">
                        {{ $infoCardBadgeText }}
                    </span>
                    <div style="width: 10px; height: 10px; background: #fff; border-radius: 50%; animation: pulse-bright 2s ease-in-out infinite; position: relative; z-index: 2;"></div>
                </div>
                <h3 style="font-size: 32px; font-weight: 900; background: linear-gradient(135deg, {{ $infoCardGradientStart }}, {{ $infoCardGradientEnd }}); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin: 0 0 14px 0; line-height: 1.2;">
                    {{ $infoCardTitle }}
                </h3>
            ...
            <a href="{{ $infoCardButtonLink }}" style="display: inline-flex; align-items: center; gap: 12px; padding: 18px 36px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}, {{ $infoCardGradientEnd }}); color: #fff; text-decoration: none; border-radius: 16px; font-weight: 800; font-size: 16px; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 8px 30px {{ $infoCardGradientStart }}50; white-space: nowrap; position: relative; z-index: 2; overflow: hidden;" onmouseover="this.style.transform='translateY(-4px) scale(1.05)'; this.style.boxShadow='0 15px 50px {{ $infoCardGradientStart }}60';" onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 8px 30px {{ $infoCardGradientStart }}50';">
                ...
                <i class="fas {{ $infoCardButtonIcon }}" style="font-size: 15px; position: relative; z-index: 2; transition: transform 0.3s;" class="info-btn-icon"></i>
                @endif
            </a>
        </div>

        @elseif($infoCardLayoutStyle === 'compact')
        {{-- LAYOUT 2: Bold Bento Card --}}
        <div style="background: linear-gradient(135deg, #fff 0%, {{ $infoCardGradientEnd }}08 100%); border: 3px solid transparent; background-image: linear-gradient(135deg, #fff 0%, {{ $infoCardGradientEnd }}08 100%), linear-gradient(135deg, {{ $infoCardGradientStart }}, {{ $infoCardGradientEnd }}); background-origin: border-box; background-clip: padding-box, border-box; border-radius: 20px; padding: 35px 40px; display: flex; justify-content: space-between; align-items: center; gap: 30px; box-shadow: 0 12px 45px rgba(0,0,0,0.1); transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden;" onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 20px 60px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 12px 45px rgba(0,0,0,0.1)';">
            <!-- Animated Background Pattern -->
            <div style="position: absolute; top: 0; right: 0; width: 200px; height: 200px; background: radial-gradient(circle, {{ $infoCardGradientEnd }}15 0%, transparent 70%); animation: rotate-slow 20s linear infinite;"></div>
            <div style="position: absolute; bottom: -30px; left: -30px; width: 150px; height: 150px; background: radial-gradient(circle, {{ $infoCardGradientStart }}12 0%, transparent 70%);"></div>
            
            <!-- Geometric Accent -->
            <div style="position: absolute; top: 20px; right: 20px; width: 60px; height: 60px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}20, {{ $infoCardGradientEnd }}20); border-radius: 12px; transform: rotate(45deg); opacity: 0.3;"></div>
            
            <div style="display: flex; align-items: center; gap: 25px; flex: 1; position: relative; z-index: 2;">
                <!-- Animated Icon Box -->
                <div style="width: 70px; height: 70px; background: linear-gradient(135deg, {{ $infoCardGradientStart }} 0%, {{ $infoCardGradientEnd }} 100%); border-radius: 18px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 10px 35px {{ $infoCardGradientStart }}45; position: relative; overflow: hidden; transition: transform 0.3s;" onmouseover="this.style.transform='rotate(5deg) scale(1.1)';" onmouseout="this.style.transform='rotate(0deg) scale(1)';">
                    <div style="position: absolute; top: -50%; left: -50%; width: 200%; height: 200%; background: linear-gradient(45deg, transparent, rgba(255,255,255,0.2), transparent); animation: rotate-shine 3s linear infinite;"></div>
                    @if($infoCardBadgeIcon)
                        <i class="fas {{ $infoCardBadgeIcon }}" style="font-size: 32px; color: #fff; position: relative; z-index: 2; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));"></i>
                    @else
                        <i class="fas fa-info-circle" style="font-size: 32px; color: #fff; position: relative; z-index: 2; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));"></i>
                    @endif
                </div>
                
                <div>
                    <div style="display: inline-flex; align-items: center; gap: 8px; padding: 5px 14px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}18, {{ $infoCardGradientEnd }}18); border: 1.5px solid {{ $infoCardGradientStart }}30; border-radius: 20px; margin-bottom: 10px;">
                        <div style="width: 6px; height: 6px; background: {{ $infoCardGradientStart }}; border-radius: 50%; animation: pulse-bright 2s ease-in-out infinite;"></div>
                        <span style="font-size: 11px; font-weight: 800; color: {{ $infoCardGradientStart }}; letter-spacing: 1px; text-transform: uppercase;">{{ $infoCardBadgeText }}</span>
                    </div>
                    <h3 style="font-size: 22px; font-weight: 900; color: {{ $infoCardTitleColor }}; margin: 0 0 8px 0; line-height: 1.2;">
                        {{ $infoCardTitle }}
                    </h3>
                    <p style="font-size: 15px; color: {{ $infoCardSubtitleColor }}; margin: 0; line-height: 1.6; font-weight: 500;">{{ $infoCardSubtitle }}</p>
                </div>
            </div>
            ...
            <a href="{{ $infoCardButtonLink }}" style="display: inline-flex; align-items: center; gap: 10px; padding: 16px 32px; background: linear-gradient(135deg, {{ $infoCardGradientStart }} 0%, {{ $infoCardGradientEnd }} 100%); color: #fff; text-decoration: none; border-radius: 14px; font-weight: 800; font-size: 15px; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 8px 30px {{ $infoCardGradientStart }}45, inset 0 -2px 8px rgba(0,0,0,0.15); white-space: nowrap; flex-shrink: 0; position: relative; z-index: 2; overflow: hidden;" onmouseover="this.style.transform='translateY(-3px) scale(1.05)'; this.style.boxShadow='0 12px 40px {{ $infoCardGradientStart }}55, inset 0 -2px 8px rgba(0,0,0,0.15)';" onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 8px 30px {{ $infoCardGradientStart }}45, inset 0 -2px 8px rgba(0,0,0,0.15)';">
                ...
                <span style="position: relative; z-index: 2;">{{ $infoCardButtonText }}</span>
                @if($infoCardButtonIcon)
                <i class="fas {{ $infoCardButtonIcon }}" style="font-size: 14px; position: relative; z-index: 2; transition: transform 0.3s;" class="compact-btn-icon"></i>
                @endif
            </a>
        </div>

        @elseif($infoCardLayoutStyle === 'gradient')
        {{-- LAYOUT 3: Modern Gradient with Glassmorphism --}}
        <div style="background: linear-gradient(135deg, {{ $infoCardGradientStart }} 0%, {{ $infoCardGradientEnd }} 100%); border-radius: 24px; padding: 50px; display: flex; justify-content: space-between; align-items: center; position: relative; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">
            <!-- Decorative Elements -->
            <div style="position: absolute; top: -50px; right: -50px; width: 200px; height: 200px; background: rgba(255,255,255,0.1); border-radius: 50%; backdrop-filter: blur(10px);"></div>
            <div style="position: absolute; bottom: -80px; left: -80px; width: 250px; height: 250px; background: rgba(255,255,255,0.08); border-radius: 50%; backdrop-filter: blur(10px);"></div>
            
            <div style="position: relative; z-index: 2; flex: 1;">
                <div style="display: inline-flex; align-items: center; gap: 10px; padding: 8px 20px; background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.3); border-radius: 30px; margin-bottom: 20px;">
                    @if($infoCardBadgeIcon)
                        <i class="fas {{ $infoCardBadgeIcon }}" style="font-size: 14px; color: #fff;"></i>
                    @endif
                    <span style="font-size: 13px; font-weight: 700; color: #fff; letter-spacing: 1px; text-transform: uppercase;">
                        {{ $infoCardBadgeText }}
                    </span>
                    <div style="width: 8px; height: 8px; background: #fbbf24; border-radius: 50%; animation: pulse-dot 2s ease-in-out infinite;"></div>
                </div>
                <h3 style="font-size: 32px; font-weight: 800; color: #fff; margin: 0 0 12px 0; line-height: 1.2;">
                    {{ $infoCardTitle }}
                </h3>
        ...
        @elseif($infoCardLayoutStyle === 'modern')
        {{-- LAYOUT 4: Modern Card with Icon --}}
        <div style="background: #fff; border: 2px solid {{ $infoCardBorderColor }}; border-radius: 20px; padding: 45px; display: flex; justify-content: space-between; align-items: center; gap: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.08); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 20px 60px rgba(0,0,0,0.12)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 40px rgba(0,0,0,0.08)';">
            <!-- Icon Section -->
            <div style="width: 80px; height: 80px; background: linear-gradient(135deg, {{ $infoCardGradientStart }} 0%, {{ $infoCardGradientEnd }} 100%); border-radius: 20px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 8px 25px {{ $infoCardGradientStart }}40;">
                @if($infoCardBadgeIcon)
                    <i class="fas {{ $infoCardBadgeIcon }}" style="font-size: 36px; color: #fff;"></i>
                @else
            ...
            <!-- Content Section -->
            <div style="flex: 1;">
                <div style="display: inline-block; padding: 6px 14px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}15, {{ $infoCardGradientEnd }}15); border-radius: 20px; margin-bottom: 12px;">
                    <span style="font-size: 11px; font-weight: 700; color: {{ $infoCardGradientStart }}; letter-spacing: 1px; text-transform: uppercase;">
                        {{ $infoCardBadgeText }}
                    </span>
                </div>
                <h3 style="font-size: 26px; font-weight: 800; color: {{ $infoCardTitleColor }}; margin: 0 0 10px 0; line-height: 1.2;">
                    {{ $infoCardTitle }}
                </h3>
                <p style="font-size: 15px; color: {{ $infoCardSubtitleColor }}; margin: 0; line-height: 1.6;">{{ $infoCardSubtitle }}</p>
            </div>
        ...
        @elseif($infoCardLayoutStyle === 'premium')
        {{-- LAYOUT 5: Premium with Campus Logo --}}
        <div style="background: linear-gradient(135deg, #f8fafc 0%, #fff 100%); border: 2px solid {{ $infoCardBorderColor }}; border-radius: 24px; padding: 0; overflow: hidden; box-shadow: 0 15px 50px rgba(0,0,0,0.1); position: relative;">
            <!-- Top Accent Bar -->
            <div style="height: 6px; background: linear-gradient(90deg, {{ $infoCardGradientStart }} 0%, {{ $infoCardGradientEnd }} 100%);"></div>
            
            <div style="padding: 45px 50px; display: flex; justify-content: space-between; align-items: center; gap: 40px;">
                <!-- Logo & Content Section -->
                <div style="display: flex; align-items: center; gap: 30px; flex: 1;">
                    @if($infoCardCampusLogo)
                    <img src="{{ $infoCardCampusLogo }}" alt="{{ $infoCardCampusName }}" style="width: 90px; height: 90px; object-fit: contain; flex-shrink: 0;">
                    @else
                    <div style="width: 90px; height: 90px; background: linear-gradient(135deg, {{ $infoCardGradientStart }} 0%, {{ $infoCardGradientEnd }} 100%); border-radius: 18px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 8px 25px {{ $infoCardGradientStart }}40;">
                        <span style="font-size: 32px; font-weight: 900; color: #fff; letter-spacing: -1px;">{{ $infoCardCampusShortName ?? 'SI' }}</span>
                    </div>
                    @endif
                    
                    <div style="flex: 1;">
                        <div style="display: inline-flex; align-items: center; gap: 8px; padding: 6px 16px; background: linear-gradient(135deg, {{ $infoCardGradientStart }}12, {{ $infoCardGradientEnd }}12); border-radius: 20px; margin-bottom: 14px; border: 1px solid {{ $infoCardGradientStart }}20;">
                            @if($infoCardBadgeIcon)
                                <i class="fas {{ $infoCardBadgeIcon }}" style="font-size: 11px; color: {{ $infoCardGradientStart }};"></i>
                            @endif
                            <span style="font-size: 11px; font-weight: 700; color: {{ $infoCardGradientStart }}; letter-spacing: 1.2px; text-transform: uppercase;">
                                {{ $infoCardBadgeText }}
                            </span>
                        </div>
                        <h3 style="font-size: 28px; font-weight: 800; color: {{ $infoCardTitleColor }}; margin: 0 0 10px 0; line-height: 1.2;">
                            {{ $infoCardTitle }}
                        </h3>
                        <p style="font-size: 16px; color: {{ $infoCardSubtitleColor }}; margin: 0; line-height: 1.6;">{{ $infoCardSubtitle }}</p>
                    </div>
                </div>
...
<style>
    ...
    a:hover .info-btn-icon,
    a:hover .compact-btn-icon {
...
@php
    ...
    try {
        ...
        $ctaShow = App\Models\Setting::where('key', 'cta_show')->value('value') ?? '0';
...
@php
    ...
    try {
        ...
        $footerSettings = [
            ...
            'email' => App\Models\Setting::where('key', 'footer_email')->value('value') ?? 'si@unib.ac.id',
            'website' => App\Models\Setting::where('key', 'footer_website')->value('value') ?? 'si.unib.ac.id',
            'subscribe_title' => App\Models\Setting::where('key', 'footer_subscribe_title')->value('value') ?? 'SUBSCRIBE',
            'subscribe_text' => App\Models\Setting::where('key', 'footer_subscribe_text')->value('value') ?? 'Get the latest updates and news from our Information Systems program',
            'subscribe_placeholder' => App\Models\Setting::where('key', 'footer_subscribe_placeholder')->value('value') ?? 'Email address',
            'subscribe_button' => App\Models\Setting::where('key', 'footer_subscribe_button')->value('value') ?? 'Subscribe Now',
        ...
        $footerColors = [
            'bg_gradient_start' => App\Models\Setting::where('key', 'footer_bg_gradient_start')->value('value') ?? '#0f172a',
            'bg_gradient_mid' => App\Models\Setting::where('key', 'footer_bg_gradient_mid')->value('value') ?? '#1a246a',
            'bg_gradient_end' => App\Models\Setting::where('key', 'footer_bg_gradient_end')->value('value') ?? '#151945',
            'text_color' => App\Models\Setting::where('key', 'footer_text_color')->value('value') ?? '#d0d0d0',
            'heading_color' => App\Models\Setting::where('key', 'footer_heading_color')->value('value') ?? '#ffffff',
            'accent_color' => App\Models\Setting::where('key', 'footer_accent_color')->value('value') ?? '#4c5db5',
        ];

        $footerSocial = [
            'facebook' => App\Models\Setting::where('key', 'footer_facebook_url')->value('value') ?? '#',
            'instagram' => App\Models\Setting::where('key', 'footer_instagram_url')->value('value') ?? '#',
            'linkedin' => App\Models\Setting::where('key', 'footer_linkedin_url')->value('value') ?? '#',
            'youtube' => App\Models\Setting::where('key', 'footer_youtube_url')->value('value') ?? '#',
        ];

        // Get footer menu from database
        $footerMenu = App\Models\Menu::where('location', 'footer')
        ...
        $footerSettings = [
            ...
            'phone' => '(0737) 21118',
            'email' => 'si@unib.ac.id',
            'website' => 'si.unib.ac.id',
            'subscribe_title' => 'SUBSCRIBE',
            'subscribe_text' => 'Get the latest updates and news from our Information Systems program',
        ...
        $footerColors = [
            ...
            'bg_gradient_mid' => '#1a246a',
            'bg_gradient_end' => '#151945',
            'text_color' => '#d0d0d0',
...
{{-- Footer Section --}}
<!-- Footer -->
<footer style="background: linear-gradient(135deg, {{ $footerColors['bg_gradient_start'] }} 0%, {{ $footerColors['bg_gradient_mid'] }} 40%, {{ $footerColors['bg_gradient_end'] }} 100%); color: {{ $footerColors['heading_color'] }}; padding: 80px 0 50px; position: relative; overflow: hidden;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 40px;">
            ...
            <div>
                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 25px;">
                    ...
                    <div>
                        <h3 style="font-size: 22px; font-weight: 700; margin: 0; color: {{ $footerColors['heading_color'] }}; letter-spacing: 1px;">{{ $footerSettings['logo_text'] }}</h3>
                        <p style="font-size: 13px; color: #f0f0f0; margin: 3px 0 0 0; font-weight: 400;">{{ $footerSettings['logo_subtext'] }}</p>
                    </div>
                </div>
                <p style="color: {{ $footerColors['text_color'] }}; font-size: 13px; line-height: 1.7; margin: 0 0 20px 0; max-width: 280px;">
                    {{ $footerSettings['description'] }}
                </p>
                
                <!-- Social Media Icons -->
                <div style="display: flex; gap: 10px;">
                    <a href="{{ $footerSocial['facebook'] }}" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: {{ $footerColors['heading_color'] }}; text-decoration: none; transition: all 0.3s; border: 1px solid rgba(255,255,255,0.2);">
                        <i class="{{ $icons['facebook'] }}" style="font-size: 14px;"></i>
                    </a>
                    <a href="{{ $footerSocial['instagram'] }}" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: {{ $footerColors['heading_color'] }}; text-decoration: none; transition: all 0.3s; border: 1px solid rgba(255,255,255,0.2);">
                        <i class="{{ $icons['instagram'] }}" style="font-size: 14px;"></i>
                    </a>
                    <a href="{{ $footerSocial['linkedin'] }}" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: {{ $footerColors['heading_color'] }}; text-decoration: none; transition: all 0.3s; border: 1px solid rgba(255,255,255,0.2);">
                        <i class="{{ $icons['linkedin_in'] }}" style="font-size: 14px;"></i>
                    </a>
                    <a href="{{ $footerSocial['youtube'] }}" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: {{ $footerColors['heading_color'] }}; text-decoration: none; transition: all 0.3s; border: 1px solid rgba(255,255,255,0.2);">
                        <i class="{{ $icons['youtube'] }}" style="font-size: 14px;"></i>
                    </a>
                </div>
            </div>
            ...
            <div>
                <h4 style="font-size: 16px; font-weight: 600; margin: 0 0 20px 0; color: {{ $footerColors['heading_color'] }}; text-transform: uppercase; letter-spacing: 2px; position: relative;">
                    {{ $footerSettings['quicklinks_title'] }}
            ...
            <div>
                ...
                <ul style="list-style: none; padding: 0; margin: 15px 0 0 0;">
                    <li style="margin-bottom: 16px; display: flex; align-items: flex-start; gap: 12px;">
                        <i class="{{ $icons['location'] }}" style="color: {{ $footerColors['accent_color'] }}; font-size: 14px; margin-top: 2px;"></i>
                        <span style="color: {{ $footerColors['text_color'] }}; font-size: 13px; line-height: 1.6;">{{ $footerSettings['address'] }}</span>
                    </li>
                    <li style="margin-bottom: 16px; display: flex; align-items: center; gap: 12px;">
                        <i class="{{ $icons['phone'] }}" style="color: {{ $footerColors['accent_color'] }}; font-size: 14px;"></i>
                        <span style="color: {{ $footerColors['text_color'] }}; font-size: 13px;">{{ $footerSettings['phone'] }}</span>
                    </li>
                    <li style="margin-bottom: 16px; display: flex; align-items: center; gap: 12px;">
                        <i class="{{ $icons['envelope'] }}" style="color: {{ $footerColors['accent_color'] }}; font-size: 14px;"></i>
                        <span style="color: {{ $footerColors['text_color'] }}; font-size: 13px;">{{ $footerSettings['email'] }}</span>
                    </li>
                    <li style="display: flex; align-items: center; gap: 12px;">
                        <i class="{{ $icons['globe'] }}" style="color: {{ $footerColors['accent_color'] }}; font-size: 14px;"></i>
                        <span style="color: {{ $footerColors['text_color'] }}; font-size: 13px;">{{ $footerSettings['website'] }}</span>
                    </li>
                </ul>
            </div>
...
@else
{{-- Footer is disabled or not configured - Show Admin Placeholder --}}
<footer style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); color: #fff; padding: 60px 0; position: relative; overflow: hidden;">
    <div style="position: absolute; top: -50px; right: -50px; width: 200px; height: 200px; background: radial-gradient(circle, rgba(59, 130, 246, 0.05) 0%, transparent 70%); border-radius: 50%;"></div>
    <div style="position: absolute; bottom: -60px; left: -60px; width: 220px; height: 220px; background: radial-gradient(circle, rgba(76, 93, 181, 0.05) 0%, transparent 70%); border-radius: 50%;"></div>
    
    <div class="container" style="position: relative; z-index: 2;">
        <div style="text-align: center; max-width: 550px; margin: 0 auto; padding: 40px;">
            <!-- Icon -->
            <div style="width: 75px; height: 75px; background: rgba(255,255,255,0.08); backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.15); border-radius: 18px; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 25px;">
                <i class="fas fa-shoe-prints" style="font-size: 34px; color: rgba(255,255,255,0.6);"></i>
            </div>
            
            <!-- Title -->
            <h3 style="font-size: 26px; font-weight: 900; color: #fff; margin: 0 0 12px 0; line-height: 1.2;">
                Footer Belum Dilengkapi
            </h3>
            
            <!-- Description -->
            <p style="font-size: 15px; color: rgba(255,255,255,0.7); margin: 0 0 30px 0; line-height: 1.7;">
                Section footer belum dikonfigurasi oleh administrator. Hubungi admin untuk melengkapi informasi kontak, sosial media, dan tautan penting lainnya.
            </p>
            
            <!-- Admin Badge -->
            <div style="display: inline-flex; align-items: center; gap: 9px; padding: 11px 24px; background: rgba(255,255,255,0.08); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.15); border-radius: 25px;">
                <i class="fas fa-cog" style="font-size: 13px; color: rgba(59,130,246,0.9);"></i>
                <span style="font-size: 13px; font-weight: 700; color: rgba(255,255,255,0.85); letter-spacing: 0.3px;">Configuration Needed</span>
            </div>
        </div>
        ...
        <div style="text-align: center; margin-top: 40px; padding-top: 30px; border-top: 1px solid rgba(255,255,255,0.1);">
            <p style="font-size: 13px; color: rgba(255,255,255,0.5); margin: 0;">
                © {{ date('Y') }} - Website Configuration Needed
            </p>
        </div>
    </div>
</footer>
