...
$user->can('posts.create')              // Same as hasPermission
$user->cannot('posts.delete')           // Opposite of can
...
// Quick Role Checks
$user->isSuperadmin()
$user->isAdmin()                        // admin OR superadmin
$user->isEditor()
$user->isAuthor()
$user->isViewer()
...
### Available Methods (HasRoleAndPermission Trait)

```php
// Permission Methods
->hasPermission($permission)      // Check single permission
->can($permission)                // Alias for hasPermission
->cannot($permission)             // Opposite of can
