...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'cta_badge_text', 'value' => 'JADILAH BAGIAN DARI REVOLUSI DIGITAL', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'cta_badge_show', 'value' => '1', 'type' => 'boolean', 'group' => 'homepage'],
            ['key' => 'cta_title', 'value' => 'Siap Bergabung Bersama Kami?', 'type' => 'string', 'group' => 'homepage'],
            ['key' => 'cta_subtitle', 'value' => 'Daftar sekarang dan raih masa depan cemerlang di bidang Sistem Informasi', 'type' => 'string', 'group' => 'homepage'],
