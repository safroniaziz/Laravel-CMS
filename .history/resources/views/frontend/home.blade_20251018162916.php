...
<div style="{{ $slider->image_position === 'left' ? 'direction: ltr;' : '' }}; height: 55vh; display: flex; align-items: center;" data-aos="fade-{{ $slider->image_position === 'left' ? 'right' : 'left' }}" data-aos-duration="1000" data-aos-delay="200">
