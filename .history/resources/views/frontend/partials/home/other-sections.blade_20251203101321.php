...
<section style="padding: 90px 0; background: linear-gradient(to bottom, #f8fafc 0%, #ffffff 100%); position: relative;">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        ...
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            <div style="display: inline-flex; align-items: center; gap: 10px; padding: 10px 24px; background: #fff; border: 2px solid #1a246a; border-radius: 30px; margin-bottom: 24px; box-shadow: 0 4px 20px rgba(26, 36, 106, 0.08);">
                <div style="width: 8px; height: 8px; background: #1a246a; border-radius: 50%;"></div>
                <span style="font-size: 12px; font-weight: 700; color: #1a246a; letter-spacing: 1.5px;">INFORMASI AKADEMIK</span>
            </div>
            
            <h2 style="font-size: 46px; font-weight: 800; color: #1a246a; margin: 0 0 18px 0; line-height: 1.2;" data-aos="fade-up" data-aos-delay="100">
            ...
            <p style="font-size: 17px; color: #64748b; max-width: 650px; margin: 0 auto; line-height: 1.7;" data-aos="fade-up" data-aos-delay="200">
                Informasi terkini seputar kegiatan akademik, program mahasiswa, dan pencapaian yang membanggakan Program Studi Sistem Informasi
            </p>
        </div>
        ...
        @if($academicPosts->count() > 0)
            ...
            <div style="text-align: center;" data-aos="fade-up" data-aos-delay="400">
                <a href="{{ route('blog.index') }}?category=akademik" 
                   style="display: inline-flex; align-items: center; gap: 12px; padding: 16px 36px; background: #1a246a; color: #fff; text-decoration: none; font-weight: 600; font-size: 15px; border-radius: 8px; box-shadow: 0 4px 16px rgba(26, 36, 106, 0.2); transition: all 0.3s ease; border: 2px solid #1a246a;"
                   ...
                   onmouseout="this.style.background='#1a246a'; this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 16px rgba(26, 36, 106, 0.2)';">
