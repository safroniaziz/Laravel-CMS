...
<section style="padding: 80px 0; background: #ffffff;">
    <div class="container" data-aos="fade-up">
        ...
        <div style="background: {{ $infoCardBgColor }}; border: 1px solid {{ $infoCardBorderColor }}; border-radius: 16px; padding: 40px; display: flex; justify-content: space-between; align-items: center;">
            <div>
                <div style="display: inline-flex; align-items: center; gap: 8px; padding: 6px 16px; background: {{ $infoCardBadgeBg }}; border-radius: 20px; margin-bottom: 16px;">
                    <div style="width: 6px; height: 6px; background: {{ $infoCardBadgeDotColor }}; border-radius: 50%;"></div>
                    <span style="font-size: 12px; font-weight: 600; color: {{ $infoCardSubtitleColor }}; letter-spacing: 0.5px;">
                        @if($infoCardBadgeIcon)
                            <i class="fas {{ $infoCardBadgeIcon }}" style="font-size: 10px; margin-right: 4px; color: {{ $infoCardBadgeDotColor }};"></i>
                        @endif
                        {{ $infoCardBadgeText }}
                    </span>
                </div>
                <h3 style="font-size: 24px; font-weight: 700; color: {{ $infoCardTitleColor }}; margin: 0 0 8px 0;">
                    {{ $infoCardTitle }}
                </h3>
                <p style="font-size: 16px; color: {{ $infoCardSubtitleColor }}; margin: 0;">{{ $infoCardSubtitle }}</p>
            </div>
            <a href="{{ $infoCardButtonLink }}" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; background: {{ $infoCardButtonBg }}; color: {{ $infoCardButtonTextColor }}; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px; transition: all 0.2s; border: 1px solid {{ $infoCardButtonBorderColor }};" class="clean-btn">
                <span>{{ $infoCardButtonText }}</span>
                @if($infoCardButtonIcon)
                <i class="fas {{ $infoCardButtonIcon }}" style="font-size: 12px;"></i>
                @endif
            </a>
        </div>
        @elseif($infoCardLayoutStyle === 'compact')
        <div style="background: {{ $infoCardBgColor }}; border: 1px solid {{ $infoCardBorderColor }}; border-radius: 16px; padding: 24px 28px; display: flex; justify-content: space-between; align-items: center; gap: 20px;">
            <div>
                <h3 style="font-size: 20px; font-weight: 700; color: {{ $infoCardTitleColor }}; margin: 0 0 6px 0;">
                    {{ $infoCardTitle }}
                </h3>
                <p style="font-size: 14px; color: {{ $infoCardSubtitleColor }}; margin: 0;">{{ $infoCardSubtitle }}</p>
            </div>
            <a href="{{ $infoCardButtonLink }}" style="display: inline-flex; align-items: center; gap: 6px; padding: 10px 20px; background: {{ $infoCardButtonBg }}; color: {{ $infoCardButtonTextColor }}; text-decoration: none; border-radius: 999px; font-weight: 600; font-size: 14px; border: 1px solid {{ $infoCardButtonBorderColor }};">
                <span>{{ $infoCardButtonText }}</span>
                @if($infoCardButtonIcon)
                <i class="fas {{ $infoCardButtonIcon }}" style="font-size: 11px;"></i>
                @endif
            </a>
        </div>
        @endif
