...
<section style="padding: 80px 0; background: linear-gradient(135deg, {{ $alumniBgGradient['start'] }} 0%, {{ $alumniBgGradient['end'] }} 100%); position: relative; overflow: hidden;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        @else
        <div style="display: grid; grid-template-columns: 1fr; gap: 60px; align-items: center; text-align: center;" data-aos="fade-up">
        @endif
            <!-- Left Side - Content -->
            <div>
                ...
                <div style="text-align: center; padding: 60px 40px;">
                    <div style="background: rgba(255, 107, 53, 0.1); border: 2px dashed rgba(255, 107, 53, 0.3); border-radius: 20px; padding: 40px; max-width: 500px; margin: 0 auto;">
                        <div style="font-size: 64px; margin-bottom: 20px; opacity: 0.7;">📋</div>
                        <h3 style="font-size: 24px; font-weight: 700; color: #1e293b; margin: 0 0 15px 0;">
                            Data Alumni Belum Tersedia
                        </h3>
                        <p style="font-size: 16px; color: #64748b; margin: 0 0 20px 0; line-height: 1.6;">
                            Testimoni dan data alumni belum ditambahkan oleh administrator. Silakan hubungi admin untuk menambahkan konten di section ini.
                        </p>
                        <div style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; background: linear-gradient(135deg, {{ $alumniAccentGradient['start'] }}, {{ $alumniAccentGradient['end'] }}); color: #fff; border-radius: 12px; font-size: 14px; font-weight: 600;">
