            ...
            @foreach($categories as $category)
                <div style="display: flex; flex-direction: column; height: 100%;">
                    ...
                    <div style="margin-bottom: 24px; position: relative; border-bottom: 1px solid #e2e8f0; padding-bottom: 12px;">
                        <h3 style="font-size: 24px; font-weight: 700; color: #1a246a; margin: 0; font-family: 'Outfit', sans-serif;">
                            {{ $category['title'] }}
                        </h3>
                        {{-- Accent Line --}}
                    ...
                    @if($category['posts']->count() > 0)
                        ...
                        <article onclick="window.location='{{ route('blog.show', $mainPost->slug) }}'"
                            ...
                            <h4 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0 0 8px 0; line-height: 1.4; transition: color 0.3s ease;" onmouseover="this.style.color='#1a246a';" onmouseout="this.style.color='#1e293b';">
                                {{ $mainPost->title }}
                            </h4>
                        ...
                        <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
                            @foreach($category['posts']->skip(1)->take(2) as $smallPost)
                                <article onclick="window.location='{{ route('blog.show', $smallPost->slug) }}'"
                                    ...
                                    <div>
                                        <h5 style="font-size: 14px; font-weight: 600; color: #1e293b; margin: 0 0 6px 0; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; transition: color 0.3s ease;" onmouseover="this.style.color='#1a246a';" onmouseout="this.style.color='#1e293b';">
                                            {{ $smallPost->title }}
                                        </h5>
                        ...
                        <div style="margin-top: 24px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
                            <a href="{{ route('blog.index') }}?category={{ $category['slug'] }}" style="display: flex; align-items: center; justify-content: center; width: 100%; padding: 10px 0; border: 1px solid #1a246a; border-radius: 6px; color: #1a246a; font-size: 13px; font-weight: 600; text-decoration: none; transition: all 0.3s ease;"
                               onmouseover="this.style.background='#1a246a'; this.style.color='#fff';"
                               onmouseout="this.style.background='transparent'; this.style.color='#1a246a';">
                                LIHAT SEMUA
