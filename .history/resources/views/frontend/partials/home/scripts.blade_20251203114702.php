...
$(document).ready(function() {
    ...
    let currentSlide = 0;
    const carouselTrack = $('#alumni-carousel-track');
    const slides = $('.alumni-carousel-slide');
    const totalSlides = slides.length;
    const indicators = $('.alumni-carousel-indicator');
    const indicatorsContainer = indicators.parent();
    const accentColor = indicatorsContainer.length ? indicatorsContainer.data('accent-color') || '#ff6b35' : '#ff6b35';

    function updateCarousel() {
        if (carouselTrack.length && slides.length) {
            ...
            indicators.each(function(index) {
                if (index === currentSlide) {
                    $(this).css('background', accentColor);
                } else {
