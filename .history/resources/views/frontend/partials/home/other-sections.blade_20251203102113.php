    ...
    <div class="container" style="position: relative; z-index: 1;">
        ...
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            <div style="display: inline-flex; align-items: center; gap: 10px; padding: 10px 24px; background: #fff; border: 2px solid #1a246a; border-radius: 30px; margin-bottom: 24px; box-shadow: 0 4px 20px rgba(26, 36, 106, 0.08);">
                ...
                <span style="font-size: 12px; font-weight: 700; color: #1a246a; letter-spacing: 1.5px;">{{ $academicHeader['badge_text'] }}</span>
                @if($academicHeader['icon'])
                    <i class="fas {{ $academicHeader['icon'] }}" style="color: #1a246a; font-size: 14px;"></i>
                @endif
            </div>
