...
<section style="padding: 80px 0; background: linear-gradient(to bottom, #f8fafc, #ffffff); position: relative;">
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            <div style="display: inline-block; padding: 8px 20px; background: linear-gradient(135deg, #dbeafe, #bfdbfe); border-radius: 50px; margin-bottom: 15px;">
                <span style="font-size: 13px; font-weight: 700; color: #1e40af; letter-spacing: 1px;">📰 INFORMASI TERKINI</span>
            </div>
            
            <h2 style="font-size: 42px; font-weight: 900; color: #0f172a; margin: 0 0 15px 0; position: relative; display: inline-block;">
                {{ $homeSettings['home_news_title'] ?? 'BERITA TERKINI' }}
            </h2>
            <div style="width: 100px; height: 5px; background: linear-gradient(to right, #1e3a8a, #f97316); margin: 0 auto 20px; border-radius: 10px;"></div>
