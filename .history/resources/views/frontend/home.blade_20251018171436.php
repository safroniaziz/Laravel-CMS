                ...
                <div class="dosen-slides" style="display: flex; transition: transform 0.6s ease;">
                    ...
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 25px;">
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #f8fafc, #e2e8f0); display: flex; align-items: center; justify-content: center; color: #64748b; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-tie"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #3b82f6; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;"></div>
                                    <div style="font-size: 11px; color: #3b82f6; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Kepala Program Studi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Dr. Yudi Setiawan, S.T., M.Eng.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #fef3c7, #fbbf24); display: flex; align-items: center; justify-content: center; color: #92400e; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-graduate"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #f59e0b; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #f59e0b; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Niska Ramadhani, M.Kom.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #dbeafe, #3b82f6); display: flex; align-items: center; justify-content: center; color: #1e40af; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-cog"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #1d4ed8; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #3b82f6; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Aan Erlanshari, S.T., M.Eng.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #ecfdf5, #10b981); display: flex; align-items: center; justify-content: center; color: #047857; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-check"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #059669; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #10b981; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Soni Ayi Purnama, M.Kom.</h3>
                        </div>
                    </div>
                    ...
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 25px;">
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #fef2f2, #ef4444); display: flex; align-items: center; justify-content: center; color: #dc2626; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-cog"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #b91c1c; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #ef4444; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Yusran Panca Putra, M.Kom.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #f3e8ff, #8b5cf6); display: flex; align-items: center; justify-content: center; color: #7c3aed; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-edit"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #6d28d9; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #8b5cf6; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Julia Purnama Sari, S.T., M.Kom.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #fef7ff, #d946ef); display: flex; align-items: center; justify-content: center; color: #c026d3; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-shield"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #a21caf; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #d946ef; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Tiara Eka Putri, S.T., M.Kom.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: #fff; border-radius: 16px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e5e7eb; position: relative;">
                                <!-- Photo area -->
                                <div class="photo-area" style="width: 100%; height: 200px; background: linear-gradient(135deg, #f0f9ff, #0ea5e9); display: flex; align-items: center; justify-content: center; color: #0284c7; font-size: 60px; position: relative;">
                                    <i class="fas fa-user-friends"></i>
                                    <!-- Professional accent -->
                                    <div style="position: absolute; top: 15px; right: 15px; width: 8px; height: 8px; background: #0369a1; border-radius: 50%;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 20px 15px; background: #fff;">
                                    <div style="font-size: 11px; color: #0ea5e9; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 600; margin: 0; line-height: 1.3; color: #1e293b;">Andang Wijanarko, M.Kom.</h3>
                        </div>
                    </div>
                </div>
            </div>
