                ...
                <div class="academic-slides" style="display: flex; transition: transform 0.5s ease;">
                    ...
                    <div class="academic-slide" style="min-width: 100%; background: #fff; display: flex; align-items: center; gap: 30px; padding: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.08);">
                        <div style="flex-shrink: 0;">
                            <img src="https://via.placeholder.com/200x150/3b82f6/ffffff?text=Kerja+Praktik" alt="Kerja Praktik" style="width: 200px; height: 150px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        </div>
                        <div style="flex: 1;">
                    ...
                    <div class="academic-slide" style="min-width: 100%; background: #fff; display: flex; align-items: center; gap: 30px; padding: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.08);">
                        <div style="flex-shrink: 0;">
                            <img src="https://via.placeholder.com/200x150/8b5cf6/ffffff?text=AI+Lecture" alt="Visiting Lecture" style="width: 200px; height: 150px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        </div>
                        <div style="flex: 1;">
                    ...
                    <div class="academic-slide" style="min-width: 100%; background: #fff; display: flex; align-items: center; gap: 30px; padding: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.08);">
                        <div style="flex-shrink: 0;">
                            <img src="https://via.placeholder.com/200x150/f59e0b/ffffff?text=MBKM+2024" alt="MBKM Program" style="width: 200px; height: 150px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        </div>
                        <div style="flex: 1;">
