...
<section style="padding: 80px 0; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); color: #fff; position: relative; overflow: hidden;">
    ...
    <div style="position: absolute; top: -100px; left: -100px; width: 300px; height: 300px; background: radial-gradient(circle, rgba(251, 191, 36, 0.1) 0%, transparent 70%); border-radius: 50%;"></div>
    <div style="position: absolute; bottom: -150px; right: -150px; width: 400px; height: 400px; background: radial-gradient(circle, rgba(249, 115, 22, 0.1) 0%, transparent 70%); border-radius: 50%;"></div>
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            ...
            <h2 style="font-size: 48px; font-weight: 900; margin: 0 0 20px 0; text-shadow: 0 4px 20px rgba(0,0,0,0.3);">
                Dosen <span style="color: #fbbf24;">Sistem Informasi</span>
            </h2>
        ...
        <div style="position: relative; max-width: 1000px; margin: 0 auto;" data-aos="fade-up" data-aos-delay="100">
            <div class="dosen-slider" style="overflow: hidden; border-radius: 20px;">
                <div class="dosen-slides" style="display: flex; transition: transform 0.6s ease;">
                    <!-- Slide 1 -->
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px;">
                        <!-- Dosen 1 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #f8fafc, #e2e8f0); display: flex; align-items: center; justify-content: center; color: #64748b; font-size: 48px;">
                                    <i class="fas fa-user"></i>
                                </div>
                                <!-- Overlay for professional look -->
                                <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(to top, rgba(0,0,0,0.7), transparent); padding: 20px 15px 15px; color: #fff;">
                                    <div style="font-size: 12px; opacity: 0.9;">Kepala Program Studi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Dr. Yudi Setiawan, S.T., M.Eng.</h3>
                        </div>

                        <!-- Dosen 2 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #fef3c7, #fbbf24); display: flex; align-items: center; justify-content: center; color: #92400e; font-size: 48px;">
                                    <i class="fas fa-user-graduate"></i>
                                </div>
                                <!-- Overlay for professional look -->
                                <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(to top, rgba(0,0,0,0.7), transparent); padding: 20px 15px 15px; color: #fff;">
                                    <div style="font-size: 12px; opacity: 0.9;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Niska Ramadhani, M.Kom.</h3>
                        </div>

                        <!-- Dosen 3 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #ddd6fe, #8b5cf6); display: flex; align-items: center; justify-content: center; color: #5b21b6; font-size: 48px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Aan Erlanshari, S.T., M.Eng.</h3>
                        </div>

                        <!-- Dosen 4 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #dcfce7, #22c55e); display: flex; align-items: center; justify-content: center; color: #15803d; font-size: 48px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Soni Ayi Purnama, M.Kom.</h3>
                        </div>
                    </div>

                    <!-- Slide 2 -->
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
                        <!-- Dosen 5 -->
                        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 20px; padding: 25px; border: 1px solid rgba(255,255,255,0.2); text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 120px; height: 120px; border-radius: 50%; overflow: hidden; margin: 0 auto 20px; border: 4px solid rgba(255,255,255,0.3); box-shadow: 0 8px 25px rgba(0,0,0,0.2);">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #8b5cf6, #7c3aed); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 36px; font-weight: 700;">
                                    YP
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0 0 5px 0; line-height: 1.3;">Yusran Panca Putra, M.Kom.</h3>
                            <p style="font-size: 13px; opacity: 0.8; margin: 0;">Dosen Sistem Informasi</p>
                        </div>

                        <!-- Dosen 6 -->
                        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 20px; padding: 25px; border: 1px solid rgba(255,255,255,0.2); text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 120px; height: 120px; border-radius: 50%; overflow: hidden; margin: 0 auto 20px; border: 4px solid rgba(255,255,255,0.3); box-shadow: 0 8px 25px rgba(0,0,0,0.2);">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #ef4444, #dc2626); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 36px; font-weight: 700;">
                                    JP
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0 0 5px 0; line-height: 1.3;">Julia Purnama Sari, S.T., M.Kom.</h3>
                            <p style="font-size: 13px; opacity: 0.8; margin: 0;">Dosen Sistem Informasi</p>
                        </div>
                        ...
                        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 20px; padding: 25px; border: 1px solid rgba(255,255,255,0.2); text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 120px; height: 120px; border-radius: 50%; overflow: hidden; margin: 0 auto 20px; border: 4px solid rgba(255,255,255,0.3); box-shadow: 0 8px 25px rgba(0,0,0,0.2);">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #06b6d4, #0891b2); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 36px; font-weight: 700;">
                                    TE
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0 0 5px 0; line-height: 1.3;">Tiara Eka Putri, S.T., M.Kom.</h3>
                            <p style="font-size: 13px; opacity: 0.8; margin: 0;">Dosen Sistem Informasi</p>
                        </div>
                        ...
                        <div style="background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border-radius: 20px; padding: 25px; border: 1px solid rgba(255,255,255,0.2); text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 120px; height: 120px; border-radius: 50%; overflow: hidden; margin: 0 auto 20px; border: 4px solid rgba(255,255,255,0.3); box-shadow: 0 8px 25px rgba(0,0,0,0.2);">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #84cc16, #65a30d); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 36px; font-weight: 700;">
                                    AW
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0 0 5px 0; line-height: 1.3;">Andang Wijanarko, M.Kom.</h3>
                            <p style="font-size: 13px; opacity: 0.8; margin: 0;">Dosen Sistem Informasi</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="dosen-dots" style="display: flex; justify-content: center; gap: 12px; margin-top: 40px;">
                <button class="dosen-dot" data-slide="0" style="width: 12px; height: 12px; border-radius: 50%; border: 2px solid #fff; background: #fff; cursor: pointer; transition: all 0.3s;"></button>
                <button class="dosen-dot" data-slide="1" style="width: 12px; height: 12px; border-radius: 50%; border: 2px solid #fff; background: transparent; cursor: pointer; transition: all 0.3s;"></button>
            </div>
        </div>
