...
<section style="padding: 80px 0; background: #2c3e7d; color: #fff; position: relative; overflow: hidden;">
    <!-- Background Blur Effect like Screenshot -->
    <div style="position: absolute; inset: 0; background-image: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><filter id="blur"><feGaussianBlur stdDeviation="2"/></filter></defs><rect width="100" height="100" fill="%23334155" opacity="0.3" filter="url(%23blur)"/></svg>'); opacity: 0.5;"></div>
            ...
            <div class="dosen-slider" style="overflow: hidden; border-radius: 20px;">
                <div class="dosen-slides" style="display: flex; transition: transform 0.6s ease;">
                    ...
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px;">
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #fce7f3, #ec4899); display: flex; align-items: center; justify-content: center; color: #be185d; font-size: 48px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Yusran Panca Putra, M.Kom.</h3>
                        </div>

                        <!-- Dosen 6 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #fef2f2, #ef4444); display: flex; align-items: center; justify-content: center; color: #dc2626; font-size: 48px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Julia Purnama Sari, S.T., M.Kom.</h3>
                        </div>

                        <!-- Dosen 7 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #ecfeff, #06b6d4); display: flex; align-items: center; justify-content: center; color: #0891b2; font-size: 48px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Tiara Eka Putri, S.T., M.Kom.</h3>
                        </div>

                        <!-- Dosen 8 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 200px; height: 250px; border-radius: 15px; overflow: hidden; margin: 0 auto 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative;">
                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #f0fdf4, #22c55e); display: flex; align-items: center; justify-content: center; color: #16a34a; font-size: 48px;">
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #fff;">Andang Wijanarko, M.Kom.</h3>
                        </div>
                    </div>
                </div>
            </div>
