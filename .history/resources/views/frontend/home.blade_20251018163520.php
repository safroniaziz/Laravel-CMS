...
<section style="padding: 80px 0; background: linear-gradient(to bottom, #f8fafc, #ffffff); position: relative; margin-top: 0;">
    <div class="container">
        <!-- Dynamic Title & Subtitle - Enhanced Modern Design -->
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            <!-- Premium Badge with Animation -->
            <div style="margin-bottom: 30px; position: relative;">
                <div style="display: inline-flex; align-items: center; gap: 12px; padding: 12px 30px; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 50%, #1e40af 100%); border-radius: 50px; box-shadow: 0 8px 32px rgba(30, 58, 138, 0.3); position: relative; overflow: hidden; border: 2px solid rgba(255,255,255,0.1);">
                    <!-- Animated shine effect -->
                    <div style="position: absolute; top: 0; left: -100%; width: 100%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.2), transparent); animation: shine 2s ease-in-out infinite;"></div>

                    <!-- Icon with glow -->
                    <div style="width: 32px; height: 32px; background: linear-gradient(135deg, #fbbf24, #f97316); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 0 20px rgba(251, 191, 36, 0.5); position: relative; z-index: 1;">
                        <i class="fas fa-newspaper" style="color: #fff; font-size: 16px;"></i>
                    </div>

                    <!-- Text with gradient -->
                    <span style="font-size: 14px; font-weight: 800; background: linear-gradient(135deg, #fbbf24, #ffffff, #f97316); -webkit-background-clip: text; -webkit-text-fill-color: transparent; letter-spacing: 2px; text-transform: uppercase; position: relative; z-index: 1;">INFORMASI TERKINI</span>

                    <!-- Pulse dot -->
                    <div style="width: 8px; height: 8px; background: #10b981; border-radius: 50%; box-shadow: 0 0 0 0 #10b981; animation: pulse-dot 2s infinite; position: relative; z-index: 1;"></div>
                </div>

                <!-- Floating decorative elements -->
                <div style="position: absolute; top: -10px; left: 50%; transform: translateX(-50%); width: 200px; height: 60px; background: radial-gradient(ellipse, rgba(59, 130, 246, 0.1) 0%, transparent 70%); border-radius: 50%; z-index: -1;"></div>
            </div>

            <!-- Main Title with Enhanced Typography -->
            <h2 style="font-size: 48px; font-weight: 900; background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 50%, #374151 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin: 0 0 25px 0; line-height: 1.2; text-shadow: 0 4px 20px rgba(0,0,0,0.1); position: relative;">
                {{ $homeSettings['home_news_title'] ?? 'BERITA TERKINI' }}

                <!-- Decorative underline -->
                <div style="position: absolute; bottom: -8px; left: 50%; transform: translateX(-50%); width: 120px; height: 6px; background: linear-gradient(135deg, #1e3a8a, #3b82f6, #f97316); border-radius: 10px; box-shadow: 0 4px 15px rgba(30, 58, 138, 0.3);"></div>
            </h2>

            @if(($homeSettings['home_news_show_subtitle'] ?? '1') == '1' && !empty($homeSettings['home_news_subtitle']))
                <p style="font-size: 18px; color: #64748b; margin: 0 auto; max-width: 700px; line-height: 1.8; font-weight: 400; position: relative;">
