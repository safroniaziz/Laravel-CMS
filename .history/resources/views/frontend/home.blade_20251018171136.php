            ...
            <div class="dosen-slider" style="overflow: hidden; border-radius: 20px;">
                <div class="dosen-slides" style="display: flex; transition: transform 0.6s ease;">
                    ...
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 25px;">
                        ...
                        <!-- Dosen 2 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 20px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 15px 35px rgba(240, 147, 251, 0.3); position: relative; transform: rotate(1deg);">
                                <!-- Decorative elements -->
                                <div style="position: absolute; top: -15px; left: -15px; width: 50px; height: 50px; background: rgba(255,255,255,0.15); border-radius: 50%;"></div>
                                <div style="position: absolute; bottom: -20px; right: -20px; width: 70px; height: 70px; background: rgba(255,255,255,0.1); border-radius: 50%; backdrop-filter: blur(10px);"></div>
                                ...
                                <div style="width: 100%; height: 200px; background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 70px; position: relative;">
                                    ...
                                    <!-- Shine effect -->
                                    <div style="position: absolute; top: 0; left: -100%; width: 50%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.3), transparent); animation: shine 3s ease-in-out infinite 0.5s;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 15px; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
                                    <div style="font-size: 12px; color: #f5576c; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #1e293b;">Niska Ramadhani, M.Kom.</h3>
                        </div>

                        <!-- Dosen 3 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 20px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 15px 35px rgba(79, 172, 254, 0.3); position: relative; transform: rotate(-1deg);">
                                <!-- Decorative elements -->
                                <div style="position: absolute; top: -10px; right: -25px; width: 80px; height: 80px; background: rgba(255,255,255,0.1); border-radius: 50%;"></div>
                                <div style="position: absolute; bottom: -15px; left: -15px; width: 45px; height: 45px; background: rgba(255,255,255,0.15); border-radius: 50%; backdrop-filter: blur(10px);"></div>

                                <!-- Photo area -->
                                <div style="width: 100%; height: 200px; background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 70px; position: relative;">
                                    <i class="fas fa-user-cog"></i>
                                    <!-- Shine effect -->
                                    <div style="position: absolute; top: 0; left: -100%; width: 50%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.3), transparent); animation: shine 3s ease-in-out infinite 1s;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 15px; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
                                    <div style="font-size: 12px; color: #4facfe; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #1e293b;">Aan Erlanshari, S.T., M.Eng.</h3>
                        </div>

                        <!-- Dosen 4 -->
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            <div style="width: 220px; height: 280px; background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); border-radius: 20px; overflow: hidden; margin: 0 auto 20px; box-shadow: 0 15px 35px rgba(168, 237, 234, 0.3); position: relative; transform: rotate(2deg);">
                                <!-- Decorative elements -->
                                <div style="position: absolute; top: -25px; left: -10px; width: 65px; height: 65px; background: rgba(255,255,255,0.15); border-radius: 50%;"></div>
                                <div style="position: absolute; bottom: -5px; right: -15px; width: 35px; height: 35px; background: rgba(255,255,255,0.2); border-radius: 50%; backdrop-filter: blur(10px);"></div>

                                <!-- Photo area -->
                                <div style="width: 100%; height: 200px; background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 70px; position: relative;">
                                    <i class="fas fa-user-check"></i>
                                    <!-- Shine effect -->
                                    <div style="position: absolute; top: 0; left: -100%; width: 50%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.3), transparent); animation: shine 3s ease-in-out infinite 1.5s;"></div>
                                </div>

                                <!-- Info section -->
                                <div style="padding: 15px; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
                                    <div style="font-size: 12px; color: #fed6e3; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px;">Dosen Sistem Informasi</div>
                                </div>
                            </div>
                            <h3 style="font-size: 16px; font-weight: 700; margin: 0; line-height: 1.3; color: #1e293b;">Soni Ayi Purnama, M.Kom.</h3>
                        </div>
                    </div>
