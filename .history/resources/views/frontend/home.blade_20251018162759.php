...
<section style="position: relative; overflow: hidden; margin: -80px 0 0 0; padding: 80px 0 0 0;">
    @if($sliders->count() > 0)
        <div class="hero-slider" style="position: relative;">
            <div class="hero-slides" style="display: flex; transition: transform 0.8s cubic-bezier(0.4, 0, 0.2, 1);">
                @foreach($sliders as $index => $slider)
                    <div class="hero-slide" style="min-width: 100%; height: 100vh; background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 40%, #3b82f6 100%); position: relative; display: flex; align-items: center;">
                        ...
                        <div class="container" style="position: relative; z-index: 2; width: 100%;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center; {{ $slider->image_position === 'left' ? 'direction: rtl;' : '' }}">
                                ...
                                <div style="{{ $slider->image_position === 'left' ? 'direction: ltr;' : '' }}; height: 60vh; display: flex; align-items: center;" data-aos="fade-{{ $slider->image_position === 'left' ? 'right' : 'left' }}" data-aos-duration="1000" data-aos-delay="200">
