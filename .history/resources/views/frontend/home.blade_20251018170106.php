                ...
                <div class="dosen-slides" style="display: flex; transition: transform 0.6s ease;">
                    ...
                    <div class="dosen-slide" style="min-width: 100%; display: grid; grid-template-columns: repeat(4, 1fr); gap: 25px;">
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            ...
                            <h3 style="font-size: 18px; font-weight: 600; margin: 0; line-height: 1.3; color: #fff; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Dr. Yudi Setiawan, S.T., M.Eng.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            ...
                            <h3 style="font-size: 18px; font-weight: 600; margin: 0; line-height: 1.3; color: #fff; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Niska Ramadhani, M.Kom.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            ...
                            <h3 style="font-size: 18px; font-weight: 600; margin: 0; line-height: 1.3; color: #fff; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Aan Erlanshari, S.T., M.Eng.</h3>
                        </div>
                        ...
                        <div style="text-align: center; transition: all 0.3s;" class="dosen-card">
                            ...
                            <h3 style="font-size: 18px; font-weight: 600; margin: 0; line-height: 1.3; color: #fff; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Soni Ayi Purnama, M.Kom.</h3>
                        </div>
                    </div>
