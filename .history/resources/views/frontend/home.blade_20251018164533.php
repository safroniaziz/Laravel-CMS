...
<section style="padding: 80px 0; background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); position: relative;">
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 30px;" data-aos="fade-up" data-aos-delay="100">
            <!-- Kerja Praktik -->
            <div style="background: #fff; border-radius: 20px; padding: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e2e8f0; transition: all 0.3s;" class="academic-card">
                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                    <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 15px; display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-briefcase" style="color: #fff; font-size: 20px;"></i>
                    </div>
                    <div>
                        <h3 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0;">Kerja Praktik 2025</h3>
                        <p style="font-size: 13px; color: #64748b; margin: 0;">Program Magang Mahasiswa</p>
                    </div>
                </div>
                <p style="color: #475569; line-height: 1.6; margin-bottom: 20px;">
                    Serah terima mahasiswa kerja praktik di berbagai instansi termasuk Diskominfotik Provinsi Bengkulu untuk meningkatkan kompetensi dan pengalaman kerja.
                </p>
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-size: 12px; color: #10b981; font-weight: 600;">📅 Juni 2025</span>
                    <i class="fas fa-arrow-right" style="color: #cbd5e1; font-size: 14px;"></i>
                </div>
            </div>
            ...
            <div style="background: #fff; border-radius: 20px; padding: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e2e8f0; transition: all 0.3s;" class="academic-card">
                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                    <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #8b5cf6, #7c3aed); border-radius: 15px; display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-chalkboard-teacher" style="color: #fff; font-size: 20px;"></i>
                    </div>
                    <div>
                        <h3 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0;">Visiting Lecture</h3>
                        <p style="font-size: 13px; color: #64748b; margin: 0;">Kuliah Tamu Internasional</p>
                    </div>
                </div>
                <p style="color: #475569; line-height: 1.6; margin-bottom: 20px;">
                    Kuliah tamu bertaraf internasional dengan pembicara dari Comenius University Bratislava, Slovakia membahas "Peluang dan Tantangan AI di Sistem Informasi".
                </p>
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-size: 12px; color: #8b5cf6; font-weight: 600;">🌍 International</span>
                    <i class="fas fa-arrow-right" style="color: #cbd5e1; font-size: 14px;"></i>
                </div>
            </div>
            ...
            <div style="background: #fff; border-radius: 20px; padding: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: 1px solid #e2e8f0; transition: all 0.3s;" class="academic-card">
                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                    <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #f59e0b, #d97706); border-radius: 15px; display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-graduation-cap" style="color: #fff; font-size: 20px;"></i>
                    </div>
                    <div>
                        <h3 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0;">Program MBKM</h3>
                        <p style="font-size: 13px; color: #64748b; margin: 0;">Merdeka Belajar Kampus Merdeka</p>
                    </div>
                </div>
                <p style="color: #475569; line-height: 1.6; margin-bottom: 20px;">
                    Mahasiswa SI aktif berpartisipasi dalam program MSIB dan Kampus Mengajar 2024 untuk memperluas pengalaman dan kompetensi di luar kampus.
                </p>
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <span style="font-size: 12px; color: #f59e0b; font-weight: 600;">🚀 MSIB 2024</span>
                    <i class="fas fa-arrow-right" style="color: #cbd5e1; font-size: 14px;"></i>
                </div>
            </div>
        </div>
...
<!-- Ikatan Alumni ILUSI Section -->
<section style="padding: 80px 0; background: #fff;">
    <div class="container">
        <!-- Section Header -->
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            <div style="margin-bottom: 20px;">
                <div style="display: inline-flex; align-items: center; gap: 12px; padding: 12px 28px; background: linear-gradient(135deg, #ec4899 0%, #be185d 100%); border-radius: 25px; box-shadow: 0 8px 25px rgba(236, 72, 153, 0.3); transform: rotate(1deg);">
                    <div style="font-size: 20px;">👥</div>
                    <span style="font-size: 14px; font-weight: 700; color: #fff; letter-spacing: 1px;">IKATAN ALUMNI</span>
                </div>
            </div>
            <h2 style="font-size: 42px; font-weight: 800; background: linear-gradient(135deg, #ec4899, #be185d); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin: 0 0 15px 0;">
                ILUSI - Alumni Success Stories
            </h2>
            <p style="font-size: 17px; color: #64748b; max-width: 600px; margin: 0 auto;">
                Kisah sukses alumni Sistem Informasi UNIB yang telah berkarir di berbagai bidang
            </p>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 30px;" data-aos="fade-up" data-aos-delay="100">
            <!-- Alumni 1 -->
            <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); border-radius: 20px; padding: 30px; position: relative; overflow: hidden; border: 1px solid #e2e8f0;" class="alumni-card">
                <div style="position: absolute; top: -50px; right: -50px; width: 100px; height: 100px; background: radial-gradient(circle, rgba(236, 72, 153, 0.1) 0%, transparent 70%); border-radius: 50%;"></div>
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px; position: relative; z-index: 2;">
                    <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #3b82f6, #1e40af); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 20px;">
                        BS
                    </div>
                    <div>
                        <h3 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0;">Bagus Satria, S.Kom.</h3>
                        <p style="font-size: 14px; color: #64748b; margin: 0;">Branch Supervisor - Biznet</p>
                    </div>
                </div>
                <p style="color: #475569; line-height: 1.6; font-style: italic; position: relative; z-index: 2;">
                    "Selama menjadi mahasiswa SI UNIB saya mendapatkan banyak ilmu dan pengalaman. Fasilitas lengkap sangat mendukung kegiatan akademik dan non-akademik, bahkan saya berkesempatan keluar negeri."
                </p>
            </div>

            <!-- Alumni 2 -->
            <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); border-radius: 20px; padding: 30px; position: relative; overflow: hidden; border: 1px solid #e2e8f0;" class="alumni-card">
                <div style="position: absolute; top: -50px; right: -50px; width: 100px; height: 100px; background: radial-gradient(circle, rgba(16, 185, 129, 0.1) 0%, transparent 70%); border-radius: 50%;"></div>
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px; position: relative; z-index: 2;">
                    <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 20px;">
                        DA
                    </div>
                    <div>
                        <h3 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0;">Devi Anggraini Rahayu, S.Kom.</h3>
                        <p style="font-size: 14px; color: #64748b; margin: 0;">Admin Umum - PT. Batu Bara</p>
                    </div>
                </div>
                <p style="color: #475569; line-height: 1.6; font-style: italic; position: relative; z-index: 2;">
                    "SI UNIB banyak melahirkan generasi berprestasi. Meskipun prodi baru tapi sudah mencetak lulusan yang mampu bersaing dengan universitas lain. Kualitasnya tidak kalah saing."
                </p>
            </div>

            <!-- Alumni 3 -->
            <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); border-radius: 20px; padding: 30px; position: relative; overflow: hidden; border: 1px solid #e2e8f0;" class="alumni-card">
                <div style="position: absolute; top: -50px; right: -50px; width: 100px; height: 100px; background: radial-gradient(circle, rgba(139, 92, 246, 0.1) 0%, transparent 70%); border-radius: 50%;"></div>
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px; position: relative; z-index: 2;">
                    <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #8b5cf6, #7c3aed); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 20px;">
                        JA
                    </div>
                    <div>
                        <h3 style="font-size: 18px; font-weight: 700; color: #1e293b; margin: 0;">Jumratul Aini, S.Kom.</h3>
                        <p style="font-size: 14px; color: #64748b; margin: 0;">Staff Buyer</p>
                    </div>
                </div>
                <p style="color: #475569; line-height: 1.6; font-style: italic; position: relative; z-index: 2;">
                    "Banyak hal yang saya dapatkan dari SI UNIB, baik ilmu teknologi, etika mahasiswa, maupun attitude berorganisasi. Hal ini memudahkan adaptasi dengan dunia luar."
                </p>
            </div>
        </div>
    </div>
