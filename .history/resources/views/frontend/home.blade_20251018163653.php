        ...
        <div style="text-align: center; margin-bottom: 60px;" data-aos="fade-up">
            ...
            <div style="margin-bottom: 30px; position: relative;">
                <div style="display: inline-flex; align-items: center; gap: 15px; padding: 15px 35px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 25px; box-shadow: 0 10px 30px rgba(102, 126, 234, 0.3); position: relative; overflow: hidden; transform: rotate(-1deg);">
                    ...
                    <div style="position: absolute; inset: 0; background: url('data:image/svg+xml,<svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g fill="%23ffffff" fill-opacity="0.1"><circle cx="30" cy="30" r="4"/></g></svg>'); opacity: 0.3;"></div>
                ...
                <!-- Floating emojis -->
                <div style="position: absolute; top: -20px; left: 20%; font-size: 20px; animation: float 3s ease-in-out infinite;">📚</div>
                <div style="position: absolute; top: -15px; right: 25%; font-size: 16px; animation: float 3s ease-in-out infinite 0.5s;">💡</div>
            </div>
