                            ...
                            <div class="mb-0">
                                ...
                                <div class="d-grid gap-2">
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-4 text-start">
                                        <input type="radio" name="layout" value="full" class="btn-check" checked onchange="updateLayoutInfo()">
                                    ...
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-4 text-start">
                                        <input type="radio" name="layout" value="sidebar-right" class="btn-check" onchange="updateLayoutInfo()">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-4 text-start">
                                        <input type="radio" name="layout" value="sidebar-left" class="btn-check" onchange="updateLayoutInfo()">
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-th-large fs-2x text-primary me-4"></i>
                                            <div class="flex-grow-1">
...
function openEditBlockModal(type, index) {
    ...
    // Hide placement for hero blocks
    if (type === 'hero') {
...
function saveBlock() {
    const type = editingBlockIndex === null ?
        $('.block-type-option.selected').data('type') ||
