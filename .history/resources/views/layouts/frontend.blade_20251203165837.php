                        ...
                        @else
                            ...
                            <li>
                                <a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'active' : '' }}">
                                    <span class="menu-text-id">{{ $navigationSettings['beranda_id'] }}</span>
                                    <span class="menu-text-en">{{ $navigationSettings['beranda_en'] }}</span>
                                </a>
                            </li>
                            <li class="has-dropdown">
                                <a href="{{ route('page.show', 'about') }}" class="{{ request()->is('page/about') ? 'active' : '' }}">
                                    <span class="menu-text-id">{{ $navigationSettings['profil_id'] }}</span>
                                    <span class="menu-text-en">{{ $navigationSettings['profil_en'] }}</span>
                                </a>
                                <div class="dropdown-menu">
                                    <a href="{{ route('page.show', 'about') }}">{{ $navigationSettings['sejarah'] }}</a>
                                    <a href="{{ route('page.show', 'about') }}">{{ $navigationSettings['visi_misi'] }}</a>
                                    <a href="{{ route('page.show', 'about') }}">{{ $navigationSettings['tujuan'] }}</a>
                                    <a href="{{ route('page.show', 'about') }}">{{ $navigationSettings['dosen'] }}</a>
                                    <a href="{{ route('page.show', 'about') }}">{{ $navigationSettings['struktur'] }}</a>
                                </div>
                            </li>
                            <li>
                                <a href="{{ route('services.index') }}" class="{{ request()->routeIs('services.*') ? 'active' : '' }}">
                                    <span class="menu-text-id">{{ $navigationSettings['tridharma_id'] }}</span>
                                    <span class="menu-text-en">{{ $navigationSettings['tridharma_en'] }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('portfolio.index') }}" class="{{ request()->routeIs('portfolio.*') ? 'active' : '' }}">
                                    <span class="menu-text-id">{{ $navigationSettings['kemahasiswaan_id'] }}</span>
                                    <span class="menu-text-en">{{ $navigationSettings['kemahasiswaan_en'] }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('contact.index') }}" class="{{ request()->routeIs('contact.*') ? 'active' : '' }}">
                                    <span class="menu-text-id">{{ $navigationSettings['fasilitas_id'] }}</span>
                                    <span class="menu-text-en">{{ $navigationSettings['fasilitas_en'] }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('blog.index') }}" class="{{ request()->routeIs('blog.*') ? 'active' : '' }}">
                                    <span class="menu-text-id">{{ $navigationSettings['unduh_id'] }}</span>
                                    <span class="menu-text-en">{{ $navigationSettings['unduh_en'] }}</span>
                                </a>
                            </li>
                        @endif
                    </ul>
